...
Show # %D4 $type->influenced->all $tier->t1basescrusader
	...
	ItemLevel >= 82
	Rarity Rare
	BaseType == "Amber Amulet" "Blue Pearl Amulet" "Fugitive Boots" "Sacred Chainmail" "Turquoise Amulet"
	SetFontSize 40
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 20 110 220
...
Show # %D4 $type->influenced->all $tier->t1baseswarlord
	...
	ItemLevel >= 82
	Rarity Rare
	BaseType == "Cryonic Ring" "Feathered Arrow Quiver" "Giantslayer Helmet" "Leviathan Gauntlets" "Necrotic Armour" "Supreme Spiked Shield"
	SetFontSize 40
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 20 110 220
...
Show # %D4 $type->influenced->all $tier->t1basesredeemer
	...
	ItemLevel >= 82
	Rarity Rare
	BaseType == "Blue Pearl Amulet" "Cerulean Ring" "Dusk Ring" "Stygian Vise"
	SetFontSize 40
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 20 110 220
...
Show # %D4 $type->influenced->all $tier->t1baseshunter
	...
	ItemLevel >= 82
	Rarity Rare
	BaseType == "Blasting Wand" "Conquest Lamellar" "Divine Crown" "Leather Belt" "Nameless Ring" "Opal Ring" "Organic Ring" "Spike-Point Arrow Quiver" "Stygian Vise" "Syndicate's Garb"
	SetFontSize 40
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 20 110 220
...
Show # %D4 $type->influenced->all $tier->t1basesshaper
	...
	ItemLevel >= 82
	Rarity Rare
	BaseType == "Agate Amulet" "Anarchic Spiritblade" "Ezomyte Tower Shield" "Imperial Claw" "Karui Sceptre" "Profane Wand" "Somatic Wand" "Titanium Spirit Shield"
	SetFontSize 40
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 20 110 220
...
Show # %D4 $type->influenced->all $tier->t1baseselder
	...
	ItemLevel >= 82
	Rarity Rare
	BaseType == "Bone Helmet" "Cerulean Ring" "Cord Belt" "Giantslayer Helmet" "Imperial Claw" "Sacrificial Garb"
	SetFontSize 40
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 20 110 220
...
Show # %H5 $type->rare->exotic->talisman $tier->t1
	...
	Rarity Rare
	Class == "Amulets"
	BaseType == "Ape Talisman" "Black Maw Talisman" "Black Widow Talisman" "Blood Viper Talisman" "Carrion Queen Talisman" "Chieftain Talisman" "Chimeral Talisman" "Cobra Talisman" "Craicic Talisman" "Croaker Talisman" "Devourer Talisman" "Farric Talisman" "Fenumal Talisman" "Flame Hellion Talisman" "Frost Hellion Talisman" "Gargantuan Talisman" "Goatman Talisman" "Goliath Talisman" "Great Maw Talisman" "Greatwolf Talisman" "Hybrid Arachnid Talisman" "Lynx Talisman" "Magma Hound Talisman" "Octopus Talisman" "Pitbull Talisman" "Plagued Arachnid Talisman" "Retch Talisman" "Rhex Talisman" "Rhoa Talisman" "Sand Spitter Talisman" "Saqawine Talisman" "Savage Crab Talisman" "Scorpion Talisman" "Scrabbler Talisman" "Shield Crab Talisman" "Spider Crab Talisman" "Squid Talisman" "Taurus Talisman" "Tiger Talisman" "Ursa Talisman" "Vulture Talisman" "Watcher Talisman" "Wolf Alpha Talisman"
	SetFontSize 45
	SetTextColor 0 240 190 255
	SetBorderColor 0 240 190 255
	SetBackgroundColor 20 20 0 255
...
Show # $type->jewels->clustereco $tier->n12_i84_t1
	...
	EnchantmentPassiveNode "Bow Damage" "Dagger and Claw Damage" "Lightning Damage" "Minion Damage"
	SetFontSize 45
...
Show # $type->jewels->clustereco $tier->n11_i68_t1
	...
	EnchantmentPassiveNum 11
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage while Dual Wielding" "Bow Damage"
	SetFontSize 45
	SetTextColor 150 0 255 255
	SetBorderColor 240 100 0 255
	SetBackgroundColor 255 255 255 255
...
Show # $type->jewels->clustereco $tier->n10_i84_t1
	...
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Bow Damage"
	SetFontSize 45
	SetTextColor 150 0 255 255
	SetBorderColor 240 100 0 255
	SetBackgroundColor 255 255 255 255
...
Show # $type->jewels->clustereco $tier->n9_i84_t1
	...
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Dagger and Claw Damage"
	SetFontSize 45
	SetTextColor 150 0 255 255
	SetBorderColor 240 100 0 255
	SetBackgroundColor 255 255 255 255
...
Show # $type->jewels->clustereco $tier->n8_i84_t1
	...
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage while holding a Shield" "Axe and Sword Damage" "Chaos Damage" "Minion Damage"
	SetFontSize 45
	SetTextColor 150 0 255 255
	SetBorderColor 240 100 0 255
	SetBackgroundColor 255 255 255 255
...
Show # $type->jewels->clustereco $tier->n8_i68_t1
	...
	EnchantmentPassiveNum 8
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Cold Damage" "Damage with Two Handed Weapons" "Elemental Damage"
	SetFontSize 45
	SetTextColor 150 0 255 255
	SetBorderColor 240 100 0 255
	SetBackgroundColor 255 255 255 255
...
Show # $type->jewels->clustereco $tier->n6_i84_t1
	...
	EnchantmentPassiveNode "Life and Mana recovery from Flasks" "Minion Life" "Projectile Damage" "Trap and Mine Damage"
	SetFontSize 45
	SetTextColor 150 0 255 255
	SetBorderColor 240 100 0 255
	SetBackgroundColor 255 255 255 255
...
Show # $type->jewels->clustereco $tier->n4_i68_t1
	...
	EnchantmentPassiveNum <= 5
	BaseType == "Medium Cluster Jewel"
	EnchantmentPassiveNode "Area Damage" "Brand Damage" "Damage while you have a Herald" "Fire Damage over Time" "Totem Damage" "Trap and Mine Damage"
	SetFontSize 45
	SetTextColor 150 0 255 255
	SetBorderColor 240 100 0 255
	SetBackgroundColor 255 255 255 255
...
Show # %D8 $type->jewels->clustereco $tier->n12_i84_t2
	...
	EnchantmentPassiveNum 12
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage" "Attack Damage while Dual Wielding" "Attack Damage while holding a Shield" "Axe and Sword Damage" "Bow Damage" "Chaos Damage" "Cold Damage" "Dagger and Claw Damage" "Elemental Damage" "Fire Damage" "Lightning Damage" "Minion Damage" "Physical Damage" "Spell Damage" "Wand Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
...
Show # %D7 $type->jewels->clustereco $tier->n12_i68_t2
	...
	EnchantmentPassiveNum 12
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Chaos Damage" "Cold Damage" "Mace and Staff Damage" "Minion Damage" "Physical Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D8 $type->jewels->clustereco $tier->n11_i84_t2
	...
	EnchantmentPassiveNum 11
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage while holding a Shield" "Axe and Sword Damage" "Bow Damage" "Cold Damage" "Dagger and Claw Damage" "Elemental Damage" "Fire Damage" "Lightning Damage" "Minion Damage" "Physical Damage" "Spell Damage" "Wand Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D7 $type->jewels->clustereco $tier->n11_i68_t2
	...
	EnchantmentPassiveNum 11
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage while Dual Wielding" "Attack Damage while holding a Shield" "Bow Damage" "Wand Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D8 $type->jewels->clustereco $tier->n10_i84_t2
	...
	EnchantmentPassiveNum 10
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage" "Attack Damage while Dual Wielding" "Attack Damage while holding a Shield" "Axe and Sword Damage" "Bow Damage" "Cold Damage" "Dagger and Claw Damage" "Damage with Two Handed Weapons" "Elemental Damage" "Lightning Damage" "Mace and Staff Damage" "Minion Damage" "Spell Damage" "Wand Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D7 $type->jewels->clustereco $tier->n10_i68_t2
	...
	EnchantmentPassiveNum 10
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage while Dual Wielding" "Bow Damage" "Minion Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D8 $type->jewels->clustereco $tier->n9_i84_t2
	...
	EnchantmentPassiveNum 9
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage" "Attack Damage while Dual Wielding" "Bow Damage" "Chaos Damage" "Cold Damage" "Dagger and Claw Damage" "Lightning Damage" "Mace and Staff Damage" "Minion Damage" "Physical Damage" "Spell Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D7 $type->jewels->clustereco $tier->n9_i68_t2
	...
	EnchantmentPassiveNum 9
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Axe and Sword Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D8 $type->jewels->clustereco $tier->n8_i84_t2
	...
	EnchantmentPassiveNum 8
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage while Dual Wielding" "Attack Damage while holding a Shield" "Axe and Sword Damage" "Bow Damage" "Chaos Damage" "Cold Damage" "Dagger and Claw Damage" "Damage with Two Handed Weapons" "Elemental Damage" "Fire Damage" "Lightning Damage" "Mace and Staff Damage" "Minion Damage" "Physical Damage" "Spell Damage" "Wand Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D7 $type->jewels->clustereco $tier->n8_i75_t2
	...
	EnchantmentPassiveNum 8
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage while holding a Shield" "Axe and Sword Damage" "Bow Damage" "Chaos Damage" "Cold Damage" "Damage with Two Handed Weapons" "Elemental Damage" "Fire Damage" "Lightning Damage" "Mace and Staff Damage" "Minion Damage" "Physical Damage" "Spell Damage" "Wand Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D7 $type->jewels->clustereco $tier->n8_i68_t2
	...
	EnchantmentPassiveNum 8
	BaseType == "Large Cluster Jewel"
	EnchantmentPassiveNode "Attack Damage while Dual Wielding" "Attack Damage while holding a Shield" "Axe and Sword Damage" "Bow Damage" "Chaos Damage" "Cold Damage" "Damage with Two Handed Weapons" "Elemental Damage" "Fire Damage" "Lightning Damage" "Mace and Staff Damage" "Minion Damage" "Physical Damage" "Spell Damage" "Wand Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D8 $type->jewels->clustereco $tier->n6_i84_t2
	...
	EnchantmentPassiveNum 6
	BaseType == "Medium Cluster Jewel"
	EnchantmentPassiveNode "Area Damage" "Channelling Skill Damage" "Chaos Damage over Time" "Critical Chance" "Damage while you have a Herald" "Exerted Attack Damage" "Fire Damage over Time" "Life and Mana recovery from Flasks" "Minion Life" "Physical Damage over Time" "Projectile Damage" "Totem Damage" "Trap and Mine Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D7 $type->jewels->clustereco $tier->n6_i68_t2
	...
	EnchantmentPassiveNum 6
	BaseType == "Medium Cluster Jewel"
	EnchantmentPassiveNode "Exerted Attack Damage" "Minion Life"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D8 $type->jewels->clustereco $tier->n4_i84_t2
	...
	EnchantmentPassiveNum <= 5
	BaseType == "Medium Cluster Jewel"
	EnchantmentPassiveNode "Area Damage" "Chaos Damage over Time" "Critical Chance" "Damage while you have a Herald" "Exerted Attack Damage" "Fire Damage over Time" "Flask Duration" "Life and Mana recovery from Flasks" "Minion Damage while you have a Herald" "Minion Life" "Projectile Damage" "Totem Damage" "Trap and Mine Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D7 $type->jewels->clustereco $tier->n4_i75_t2
	...
	EnchantmentPassiveNum <= 5
	BaseType == "Medium Cluster Jewel"
	EnchantmentPassiveNode "Area Damage" "Chaos Damage over Time" "Damage while you have a Herald" "Flask Duration" "Minion Life" "Trap and Mine Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D7 $type->jewels->clustereco $tier->n4_i68_t2
	...
	EnchantmentPassiveNum <= 5
	BaseType == "Medium Cluster Jewel"
	EnchantmentPassiveNode "Area Damage" "Brand Damage" "Chaos Damage over Time" "Critical Chance" "Damage while you have a Herald" "Fire Damage over Time" "Flask Duration" "Life and Mana recovery from Flasks" "Minion Damage while you have a Herald" "Minion Life" "Physical Damage over Time" "Totem Damage" "Trap and Mine Damage"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D8 $type->jewels->clustereco $tier->n3_i84_t2
	...
	EnchantmentPassiveNum 3
	BaseType == "Small Cluster Jewel"
	EnchantmentPassiveNode "Armour" "Fire Resistance" "Life" "Mana" "Reservation Efficiency" "Suppres"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D8 $type->jewels->clustereco $tier->n2_i84_t2
	...
	EnchantmentPassiveNum 2
	BaseType == "Small Cluster Jewel"
	EnchantmentPassiveNode "Armour" "Chance to Block Attack Damage" "Curse Effect" "Mana" "Reservation Efficiency"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # %D7 $type->jewels->clustereco $tier->n2_i68_t2
	...
	EnchantmentPassiveNum 2
	BaseType == "Small Cluster Jewel"
	EnchantmentPassiveNode "Armour" "Reservation Efficiency"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 100 0 255
...
Show # $type->gems->exceptional $tier->highexceptionalbadcorrupt
	...
	BaseType == "Awakened Empower Support" "Awakened Enhance Support" "Awakened Enlighten Support" "Bloodsoaked Banner Support" "Congregation Support" "Cooldown Recovery Support" "Coursing Current Support" "Crystalfall Support" "Eclipse Support" "Empower Support" "Enhance Support" "Enlighten Support" "Frostmage Support" "Greater Ancestral Call Support" "Greater Fork Support" "Greater Multistrike Support" "Greater Spell Cascade Support" "Greater Spell Echo Support" "Greater Unleash Support" "Invert the Rules Support" "Item Quantity Support" "Pact of Beidat" "Pact of Ghorr" "Pact of K'Tash" "Pact of Lycia" "Vaal Temptation Support" "Void Shockwave Support"
	SetFontSize 45
...
Show # %D8 $type->gems->exceptional $tier->t2
	Class == "Skill Gems" "Support Gems"
	BaseType == "Coursing Current Support" "Crystalfall Support" "Empower Support" "Enhance Support" "Frostmage Support" "Greater Ancestral Call Support" "Greater Spell Cascade Support" "Greater Unleash Support" "Pact of Beidat" "Pact of Ghorr" "Pact of K'Tash" "Pact of Lycia" "Vaal Temptation Support"
	SetFontSize 45
	SetTextColor 20 240 240 255
	SetBorderColor 240 0 0 255
	SetBackgroundColor 70 0 20 255
...
Show # %D5 $type->gems->exceptional $tier->t4
	Class == "Skill Gems" "Support Gems"
	BaseType == "Bonespire Support" "Communion Support" "Cull the Weak Support" "Divine Sentinel Support" "Eldritch Blasphemy Support" "Fissure Support" "Foulgrasp Support" "Gluttony Support" "Greater Kinetic Instability Support" "Hexpass Support" "Hextoad Support" "Hiveborn Support" "Invention Support" "Lethal Dose Support" "Machinations Support" "Overheat Support" "Overloaded Intensity Support" "Pacifism Support" "Portal" "Pyre Support" "Scornful Herald Support" "Transfusion Support" "Voidstorm Support"
	SetFontSize 45
	SetTextColor 20 240 240 255
	SetBorderColor 20 240 240 255
	SetBackgroundColor 6 0 60 255
...
Show # %D8 $type->gems->special $tier->2020z
	...
	GemLevel >= 20
	Class == "Skill Gems" "Support Gems"
	BaseType == "Absolution" "Added Chaos Damage Support" "Added Cold Damage Support" "Added Fire Damage Support" "Added Lightning Damage Support" "Additional Accuracy Support" "Advanced Traps Support" "Alchemist's Mark" "Ambush" "Ancestral Call Support" "Ancestral Cry" "Anger" "Animate Guardian" "Animate Weapon" "Arcane Cloak" "Arcane Surge Support" "Arcanist Brand" "Archmage Support" "Arctic Armour" "Armageddon Brand" "Arrogance Support" "Arrow Nova Support" "Artillery Ballista" "Assassin's Mark" "Autoexertion" "Automation" "Awakened Added Chaos Damage Support" "Awakened Added Cold Damage Support" "Awakened Added Fire Damage Support" "Awakened Added Lightning Damage Support" "Awakened Ancestral Call Support" "Awakened Arrow Nova Support" "Awakened Blasphemy Support" "Awakened Brutality Support" "Awakened Burning Damage Support" "Awakened Cast On Critical Strike Support" "Awakened Cast While Channelling Support" "Awakened Chain Support" "Awakened Cold Penetration Support" "Awakened Controlled Destruction Support" "Awakened Deadly Ailments Support" "Awakened Elemental Damage with Attacks Support" "Awakened Elemental Focus Support" "Awakened Fire Penetration Support" "Awakened Fork Support" "Awakened Generosity Support" "Awakened Greater Multiple Projectiles Support" "Awakened Hextouch Support" "Awakened Lightning Penetration Support" "Awakened Melee Physical Damage Support" "Awakened Melee Splash Support" "Awakened Minion Damage Support" "Awakened Multistrike Support" "Awakened Spell Cascade Support" "Awakened Spell Echo Support" "Awakened Swift Affliction Support" "Awakened Unbound Ailments Support" "Awakened Unleash Support" "Awakened Vicious Projectiles Support" "Awakened Void Manipulation Support" "Ball Lightning" "Ballista Totem Support" "Bane" "Barrage" "Battlemage's Cry" "Behead Support" "Berserk" "Blade Blast" "Blade Flurry" "Blade Trap" "Blade Vortex" "Bladefall" "Bladestorm" "Blasphemy Support" "Blast Rain" "Blastchain Mine Support" "Blazing Salvo" "Blessed Call Support" "Blight" "Blind Support" "Blink Arrow" "Block Chance Reduction Support" "Blood Rage" "Bloodlust Support" "Bloodthirst Support" "Bodyswap" "Bone Offering" "Bonechill Support" "Boneshatter" "Brutality Support" "Burning Damage Support" "Cast On Critical Strike Support" "Cast on Death Support" "Cast on Melee Kill Support" "Cast when Damage Taken Support" "Cast when Stunned Support" "Caustic Arrow" "Chain Hook" "Chain Support" "Chance to Bleed Support" "Chance to Poison Support" "Charged Dash" "Charged Mines Support" "Charged Traps Support" "Clarity" "Cleave" "Close Combat Support" "Cluster Traps Support" "Cobra Lash" "Cold Penetration Support" "Cold to Fire Support" "Combustion Support" "Concentrated Effect Support" "Conductivity" "Conflagration" "Contagion" "Controlled Blaze Support" "Controlled Destruction Support" "Conversion Trap" "Corrupting Cry Support" "Corrupting Fever" "Crackling Lance" "Cremation" "Critical Strike Affliction Support" "Cruelty Support" "Crushing Fist" "Culling Strike Support" "Cursed Ground Support" "Cyclone" "Damage on Full Life Support" "Dash" "Deadly Ailments Support" "Decoy Totem" "Desecrate" "Despair" "Destructive Link" "Determination" "Detonate Dead" "Devour Support" "Devouring Totem" "Discharge" "Divine Blast" "Divine Ire" "Dominating Blow" "Double Strike" "Dread Banner" "Dual Strike" "Earthquake" "Earthshatter" "Efficacy Support" "Elemental Army Support" "Elemental Damage with Attacks Support" "Elemental Focus Support" "Elemental Hit" "Elemental Penetration Support" "Elemental Proliferation Support" "Elemental Weakness" "Endurance Charge on Melee Stun Support" "Enduring Cry" "Energy Blade" "Energy Leech Support" "Enfeeble" "Ensnaring Arrow" "Essence Drain" "Eternal Blessing Support" "Ethereal Knives" "Eviscerate" "Excommunicate Support" "Exemplar Support" "Expert Retaliation Support" "Explosive Arrow" "Explosive Concoction" "Explosive Trap" "Exsanguinate" "Faster Attacks Support" "Faster Casting Support" "Faster Projectiles Support" "Feeding Frenzy Support" "Fire Penetration Support" "Fire Trap" "Fireball" "Firestorm" "Flame Dash" "Flame Link" "Flame Wall" "Flameblast" "Flamewood Support" "Flammability" "Flesh and Stone" "Flesh Offering" "Flicker Strike" "Focused Ballista Support" "Focused Channelling Support" "Fork Support" "Fortify Support" "Freezing Pulse" "Frenzy" "Fresh Meat Support" "Frigid Bond Support" "Frost Blades" "Frost Shield" "Frost Wall" "Frostbite" "Frostblink" "Frostbolt" "Frozen Legion" "Galvanic Field" "General's Cry" "Glacial Cascade" "Glacial Hammer" "Glacial Shield Swipe" "Grace" "Greater Multiple Projectiles Support" "Greater Volley Support" "Ground Slam" "Hallow Support" "Haste" "Hatred" "Heavy Strike" "Hex Bloom Support" "Hexblast" "Hextouch Support" "High-Impact Mine Support" "Holy Flame Totem" "Holy Hammers" "Holy Strike" "Holy Sweep" "Hydrosphere" "Hypothermia Support" "Ice Bite Support" "Ice Crash" "Ice Nova" "Ice Shot" "Ice Spear" "Ice Trap" "Icicle Mine" "Ignite Proliferation Support" "Immolate Support" "Immortal Call" "Impale Support" "Impending Doom Support" "Incinerate" "Increased Critical Damage Support" "Increased Critical Strikes Support" "Infernal Blow" "Infernal Cry" "Infused Channelling Support" "Innervate Support" "Inspiration Support" "Intensify Support" "Intimidating Cry" "Intuitive Link" "Iron Grip Support" "Iron Will Support" "Item Rarity Support" "Kinetic Blast" "Kinetic Bolt" "Kinetic Fusillade" "Kinetic Instability Support" "Kinetic Rain" "Lancing Steel" "Leap Slam" "Less Duration Support" "Life Gain on Hit Support" "Life Leech Support" "Lifetap Support" "Lightning Arrow" "Lightning Conduit" "Lightning Penetration Support" "Lightning Spire Trap" "Lightning Strike" "Lightning Tendrils" "Lightning Warp" "Living Lightning Support" "Locus Mine Support" "Maim Support" "Malevolence" "Manabond" "Manaforged Arrows Support" "Mark On Hit Support" "Meat Shield Support" "Melee Physical Damage Support" "Melee Splash Support" "Minefield Support" "Minion Damage Support" "Minion Life Support" "Minion Speed Support" "Mirage Archer Support" "Molten Shell" "Molten Strike" "Momentum Support" "More Duration Support" "Multiple Projectiles Support" "Multiple Totems Support" "Multiple Traps Support" "Multistrike Support" "Nightblade Support" "Overcharge Support" "Overexertion Support" "Penance Brand" "Perforate" "Pestilent Strike" "Petrified Blood" "Phase Run" "Physical to Lightning Support" "Pierce Support" "Pinpoint Support" "Plague Bearer" "Poacher's Mark" "Point Blank Support" "Poisonous Concoction" "Power Charge On Critical Support" "Power Siphon" "Precision" "Predator Support" "Pride" "Prismatic Burst Support" "Protective Link" "Pulverise Support" "Puncture" "Punishment" "Purifying Flame" "Pyroclast Mine" "Rage Support" "Rage Vortex" "Raise Spectre" "Rallying Cry" "Reap" "Rejuvenation Totem" "Returning Projectiles Support" "Righteous Fire" "Rolling Magma" "Rupture Support" "Ruthless Support" "Sacred Wisps Support" "Sacrifice Support" "Sadism Support" "Scorching Ray" "Scourge Arrow" "Searing Bond" "Second Wind Support" "Seismic Cry" "Seismic Trap" "Shattering Steel" "Shield Charge" "Shield Crush" "Shock Nova" "Shockwave Support" "Shockwave Totem" "Shrapnel Ballista" "Siege Ballista" "Siphoning Trap" "Slower Projectiles Support" "Smite" "Smoke Mine" "Sniper's Mark" "Somatic Shell" "Soul Link" "Soulrend" "Spark" "Spectral Helix" "Spectral Shield Throw" "Spectral Throw" "Spell Cascade Support" "Spell Echo Support" "Spell Totem Support" "Spellblade Support" "Spellslinger" "Spirit Offering" "Split Arrow" "Splitting Steel" "Static Strike" "Steelskin" "Storm Brand" "Storm Burst" "Storm Call" "Storm Rain" "Stormbind" "Stun Support" "Summon Carrion Golem" "Summon Flame Golem" "Summon Ice Golem" "Summon Lightning Golem" "Summon Raging Spirit" "Summon Reaper" "Summon Skeletons" "Summon Skitterbots" "Summon Stone Golem" "Sunder" "Swift Affliction Support" "Swift Assembly Support" "Swordstorm" "Tempest Shield" "Temporal Chains" "Temporal Rift" "Thunderstorm" "Tornado" "Tornado Shot" "Toxic Rain" "Trap and Mine Damage Support" "Trap Support" "Trauma Support" "Trinity Support" "Unbound Ailments Support" "Unearth" "Unleash Support" "Urgent Orders Support" "Vampiric Link" "Vengeful Cry" "Venom Gyre" "Vicious Projectiles Support" "Vigilant Strike" "Vile Toxins Support" "Viper Strike" "Vitality" "Void Manipulation Support" "Void Sphere" "Volatile Dead" "Volatility Support" "Volcanic Fissure" "Volley Support" "Voltaxic Burst" "Vulnerability" "War Banner" "Warlord's Mark" "Whirling Blades" "Wild Strike" "Windburst Support" "Winter Orb" "Wintertide Brand" "Withering Step" "Withering Touch Support" "Wrath"
	SetFontSize 45
	SetTextColor 20 240 240 255
	SetBorderColor 240 0 0 255
	SetBackgroundColor 70 0 20 255
...
Show # %D8 $type->gems->special $tier->xx20z
	...
	Quality >= 19
	Class == "Skill Gems" "Support Gems"
	BaseType == "Added Cold Damage Support" "Added Lightning Damage Support" "Ambush" "Animate Guardian" "Arcane Cloak" "Arcane Surge Support" "Archmage Support" "Arrogance Support" "Arrow Nova Support" "Artillery Ballista" "Assassin's Mark" "Automation" "Ball Lightning" "Blade Blast" "Blade Vortex" "Bladefall" "Bladestorm" "Blasphemy Support" "Blast Rain" "Blight" "Blind Support" "Blood Rage" "Bloodlust Support" "Bodyswap" "Bone Offering" "Bonechill Support" "Boneshatter" "Brutality Support" "Burning Damage Support" "Cast on Death Support" "Cast when Damage Taken Support" "Caustic Arrow" "Charged Mines Support" "Charged Traps Support" "Clarity" "Cluster Traps Support" "Cold Penetration Support" "Cold to Fire Support" "Combustion Support" "Concentrated Effect Support" "Controlled Destruction Support" "Corrupting Fever" "Cremation" "Cruelty Support" "Culling Strike Support" "Cursed Ground Support" "Cyclone" "Damage on Full Life Support" "Determination" "Detonate Dead" "Divine Ire" "Dread Banner" "Dual Strike" "Efficacy Support" "Elemental Army Support" "Elemental Damage with Attacks Support" "Elemental Focus Support" "Elemental Hit" "Elemental Weakness" "Endurance Charge on Melee Stun Support" "Enduring Cry" "Energy Blade" "Energy Leech Support" "Ensnaring Arrow" "Essence Drain" "Eternal Blessing Support" "Ethereal Knives" "Explosive Arrow" "Explosive Trap" "Faster Attacks Support" "Faster Casting Support" "Faster Projectiles Support" "Fire Penetration Support" "Flame Dash" "Flesh and Stone" "Flicker Strike" "Fortify Support" "Freezing Pulse" "Frenzy" "Fresh Meat Support" "Frigid Bond Support" "Frostblink" "Frozen Legion" "Galvanic Field" "Glacial Hammer" "Grace" "Greater Multiple Projectiles Support" "Greater Volley Support" "Hallow Support" "Haste" "Hextouch Support" "High-Impact Mine Support" "Holy Strike" "Hypothermia Support" "Ice Bite Support" "Ice Shot" "Immortal Call" "Impale Support" "Impending Doom Support" "Incinerate" "Increased Critical Damage Support" "Increased Critical Strikes Support" "Inspiration Support" "Kinetic Blast" "Kinetic Fusillade" "Kinetic Instability Support" "Kinetic Rain" "Leap Slam" "Less Duration Support" "Life Leech Support" "Lifetap Support" "Lightning Arrow" "Lightning Spire Trap" "Locus Mine Support" "Maim Support" "Malevolence" "Mark On Hit Support" "Meat Shield Support" "Melee Physical Damage Support" "Melee Splash Support" "Minion Damage Support" "Minion Life Support" "Molten Shell" "Molten Strike" "More Duration Support" "Multiple Totems Support" "Multistrike Support" "Nightblade Support" "Penance Brand" "Perforate" "Pierce Support" "Plague Bearer" "Point Blank Support" "Power Charge On Critical Support" "Precision" "Pride" "Protective Link" "Raise Spectre" "Reap" "Returning Projectiles Support" "Righteous Fire" "Ruthless Support" "Sacred Wisps Support" "Searing Bond" "Seismic Cry" "Shield Charge" "Shield Crush" "Shockwave Support" "Siphoning Trap" "Smite" "Sniper's Mark" "Somatic Shell" "Soulrend" "Spell Cascade Support" "Spell Echo Support" "Steelskin" "Storm Rain" "Summon Carrion Golem" "Summon Flame Golem" "Summon Ice Golem" "Summon Lightning Golem" "Summon Reaper" "Summon Skeletons" "Summon Stone Golem" "Sunder" "Swift Affliction Support" "Tempest Shield" "Temporal Rift" "Thunderstorm" "Tornado Shot" "Toxic Rain" "Trap and Mine Damage Support" "Trauma Support" "Unbound Ailments Support" "Vitality" "Void Manipulation Support" "Void Sphere" "Volatility Support" "Voltaxic Burst" "War Banner" "Wild Strike" "Winter Orb" "Wrath"
	SetFontSize 45
	SetTextColor 20 240 240 255
	SetBorderColor 240 0 0 255
	SetBackgroundColor 70 0 20 255
...
Show # %D8 $type->gems->special $tier->2120
	...
	GemLevel >= 21
	Class == "Skill Gems" "Support Gems"
	BaseType == "Absolution" "Added Chaos Damage Support" "Added Cold Damage Support" "Added Fire Damage Support" "Additional Accuracy Support" "Ambush" "Ancestral Call Support" "Ancestral Cry" "Anger" "Animate Guardian" "Animate Weapon" "Arc" "Arcane Cloak" "Arcane Surge Support" "Arcanist Brand" "Archmage Support" "Arctic Armour" "Armageddon Brand" "Arrogance Support" "Assassin's Mark" "Autoexertion" "Automation" "Awakened Added Chaos Damage Support" "Awakened Added Cold Damage Support" "Awakened Added Fire Damage Support" "Awakened Added Lightning Damage Support" "Awakened Ancestral Call Support" "Awakened Arrow Nova Support" "Awakened Blasphemy Support" "Awakened Brutality Support" "Awakened Burning Damage Support" "Awakened Cast On Critical Strike Support" "Awakened Cast While Channelling Support" "Awakened Chain Support" "Awakened Cold Penetration Support" "Awakened Controlled Destruction Support" "Awakened Deadly Ailments Support" "Awakened Elemental Damage with Attacks Support" "Awakened Elemental Focus Support" "Awakened Fire Penetration Support" "Awakened Fork Support" "Awakened Generosity Support" "Awakened Greater Multiple Projectiles Support" "Awakened Hextouch Support" "Awakened Lightning Penetration Support" "Awakened Melee Physical Damage Support" "Awakened Melee Splash Support" "Awakened Minion Damage Support" "Awakened Multistrike Support" "Awakened Spell Cascade Support" "Awakened Spell Echo Support" "Awakened Swift Affliction Support" "Awakened Unbound Ailments Support" "Awakened Unleash Support" "Awakened Vicious Projectiles Support" "Awakened Void Manipulation Support" "Ball Lightning" "Ballista Totem Support" "Barrage" "Barrage Support" "Battlemage's Cry" "Bear Trap" "Berserk" "Blade Blast" "Blade Flurry" "Blade Vortex" "Bladefall" "Bladestorm" "Blasphemy Support" "Blast Rain" "Blastchain Mine Support" "Blessed Call Support" "Blight" "Blink Arrow" "Blood Rage" "Bloodthirst Support" "Bone Offering" "Boneshatter" "Brutality Support" "Cast On Critical Strike Support" "Cast when Damage Taken Support" "Cast when Stunned Support" "Caustic Arrow" "Chain Hook" "Chance to Poison Support" "Charged Dash" "Charged Mines Support" "Clarity" "Cobra Lash" "Cold Penetration Support" "Cold Snap" "Cold to Fire Support" "Combustion Support" "Concentrated Effect Support" "Conductivity" "Conflagration" "Consecrated Path" "Controlled Destruction Support" "Conversion Trap" "Corrupting Fever" "Crackling Lance" "Cremation" "Cruelty Support" "Culling Strike Support" "Cyclone" "Damage on Full Life Support" "Dash" "Deadly Ailments Support" "Decoy Totem" "Defiance Banner" "Desecrate" "Despair" "Determination" "Detonate Dead" "Devouring Totem" "Discipline" "Divine Blast" "Divine Ire" "Dominating Blow" "Double Strike" "Dread Banner" "Dual Strike" "Earthquake" "Efficacy Support" "Elemental Army Support" "Elemental Damage with Attacks Support" "Elemental Focus Support" "Elemental Hit" "Elemental Penetration Support" "Elemental Proliferation Support" "Elemental Weakness" "Endurance Charge on Melee Stun Support" "Enduring Cry" "Energy Blade" "Enfeeble" "Essence Drain" "Eternal Blessing Support" "Ethereal Knives" "Eviscerate" "Exemplar Support" "Explosive Arrow" "Explosive Concoction" "Explosive Trap" "Exsanguinate" "Faster Attacks Support" "Faster Casting Support" "Feeding Frenzy Support" "Fire Penetration Support" "Fireball" "Firestorm" "Flame Dash" "Flame Link" "Flame Surge" "Flame Wall" "Flameblast" "Flamethrower Trap" "Flammability" "Flesh and Stone" "Flesh Offering" "Forbidden Rite" "Fortify Support" "Freezing Pulse" "Frenzy" "Fresh Meat Support" "Frost Blades" "Frost Bomb" "Frost Shield" "Frost Wall" "Frostbite" "Frostblink" "Galvanic Field" "General's Cry" "Generosity Support" "Glacial Cascade" "Glacial Hammer" "Glacial Shield Swipe" "Grace" "Greater Volley Support" "Guardian's Blessing Support" "Hallow Support" "Haste" "Hatred" "Heavy Strike" "Hex Bloom Support" "Hexblast" "High-Impact Mine Support" "Holy Hammers" "Holy Strike" "Hydrosphere" "Hypothermia Support" "Ice Bite Support" "Ice Crash" "Ice Nova" "Ice Shot" "Icicle Mine" "Immolate Support" "Immortal Call" "Impending Doom Support" "Increased Critical Damage Support" "Increased Critical Strikes Support" "Infernal Blow" "Infernal Cry" "Innervate Support" "Inspiration Support" "Intimidating Cry" "Intuitive Link" "Item Rarity Support" "Kinetic Bolt" "Kinetic Fusillade" "Kinetic Rain" "Lacerate" "Lancing Steel" "Less Duration Support" "Life Leech Support" "Lifetap Support" "Lightning Arrow" "Lightning Conduit" "Lightning Penetration Support" "Lightning Strike" "Lightning Tendrils" "Lightning Warp" "Locus Mine Support" "Maim Support" "Malevolence" "Manaforged Arrows Support" "Mark On Hit Support" "Meat Shield Support" "Melee Physical Damage Support" "Melee Splash Support" "Minefield Support" "Minion Damage Support" "Minion Life Support" "Minion Speed Support" "Mirage Archer Support" "Mirror Arrow" "Molten Shell" "More Duration Support" "Multiple Projectiles Support" "Multiple Totems Support" "Multiple Traps Support" "Multistrike Support" "Nightblade Support" "Penance Brand" "Pestilent Strike" "Petrified Blood" "Phase Run" "Physical to Lightning Support" "Plague Bearer" "Poacher's Mark" "Poisonous Concoction" "Power Siphon" "Precision" "Pride" "Pulverise Support" "Puncture" "Punishment" "Purifying Flame" "Pyroclast Mine" "Rage Support" "Rage Vortex" "Raise Spectre" "Raise Zombie" "Rallying Cry" "Reap" "Reave" "Rejuvenation Totem" "Righteous Fire" "Rolling Magma" "Ruthless Support" "Sacred Wisps Support" "Sacrifice Support" "Scorching Ray" "Scourge Arrow" "Searing Bond" "Seismic Cry" "Seismic Trap" "Shield Charge" "Shock Nova" "Shockwave Support" "Shockwave Totem" "Shrapnel Ballista" "Siege Ballista" "Slower Projectiles Support" "Smite" "Smoke Mine" "Snipe" "Sniper's Mark" "Somatic Shell" "Soulrend" "Spectral Helix" "Spectral Shield Throw" "Spectral Throw" "Spell Echo Support" "Spellblade Support" "Spellslinger" "Spirit Offering" "Split Arrow" "Splitting Steel" "Static Strike" "Steelskin" "Storm Brand" "Storm Burst" "Storm Call" "Storm Rain" "Stormbind" "Stormblast Mine" "Summon Carrion Golem" "Summon Chaos Golem" "Summon Flame Golem" "Summon Ice Golem" "Summon Lightning Golem" "Summon Raging Spirit" "Summon Reaper" "Summon Skeletons" "Summon Skitterbots" "Summon Stone Golem" "Swift Affliction Support" "Swordstorm" "Tectonic Slam" "Tempest Shield" "Temporal Chains" "Thunderstorm" "Tornado" "Tornado Shot" "Trap and Mine Damage Support" "Trinity Support" "Unbound Ailments Support" "Unearth" "Unleash Support" "Vaal Absolution" "Vaal Arc" "Vaal Arctic Armour" "Vaal Blight" "Vaal Cyclone" "Vaal Discipline" "Vaal Domination" "Vaal Double Strike" "Vaal Grace" "Vaal Haste" "Vaal Molten Shell" "Vaal Righteous Fire" "Vaal Smite" "Vicious Projectiles Support" "Vile Toxins Support" "Viper Strike" "Vitality" "Void Manipulation Support" "Void Sphere" "Volatile Dead" "Volatility Support" "Volcanic Fissure" "Voltaxic Burst" "Vortex" "Vulnerability" "War Banner" "Warlord's Mark" "Whirling Blades" "Wild Strike" "Windburst Support" "Winter Orb" "Wintertide Brand" "Wither" "Withering Step" "Wrath" "Zealotry"
	SetFontSize 45
	SetTextColor 20 240 240 255
	SetBorderColor 240 0 0 255
	SetBackgroundColor 70 0 20 255
...
Show # %D8 $type->gems->special $tier->2023
	...
	GemLevel >= 20
	Class == "Skill Gems" "Support Gems"
	BaseType == "Added Chaos Damage Support" "Added Cold Damage Support" "Added Lightning Damage Support" "Ambush" "Ancestral Cry" "Animate Guardian" "Animate Weapon" "Arc" "Arcane Cloak" "Arcane Surge Support" "Arcanist Brand" "Arctic Armour" "Armageddon Brand" "Arrogance Support" "Arrow Nova Support" "Artillery Ballista" "Assassin's Mark" "Autoexertion" "Automation" "Awakened Added Chaos Damage Support" "Awakened Added Cold Damage Support" "Awakened Added Fire Damage Support" "Awakened Added Lightning Damage Support" "Awakened Ancestral Call Support" "Awakened Arrow Nova Support" "Awakened Blasphemy Support" "Awakened Brutality Support" "Awakened Burning Damage Support" "Awakened Cast On Critical Strike Support" "Awakened Cast While Channelling Support" "Awakened Chain Support" "Awakened Cold Penetration Support" "Awakened Controlled Destruction Support" "Awakened Deadly Ailments Support" "Awakened Elemental Damage with Attacks Support" "Awakened Elemental Focus Support" "Awakened Fire Penetration Support" "Awakened Fork Support" "Awakened Generosity Support" "Awakened Greater Multiple Projectiles Support" "Awakened Hextouch Support" "Awakened Lightning Penetration Support" "Awakened Melee Physical Damage Support" "Awakened Melee Splash Support" "Awakened Minion Damage Support" "Awakened Multistrike Support" "Awakened Spell Cascade Support" "Awakened Spell Echo Support" "Awakened Swift Affliction Support" "Awakened Unbound Ailments Support" "Awakened Unleash Support" "Awakened Vicious Projectiles Support" "Awakened Void Manipulation Support" "Ball Lightning" "Ballista Totem Support" "Barrage" "Battlemage's Cry" "Berserk" "Blade Blast" "Blade Flurry" "Bladefall" "Bladestorm" "Blast Rain" "Blessed Call Support" "Blight" "Blink Arrow" "Bone Offering" "Boneshatter" "Brutality Support" "Cast On Critical Strike Support" "Cast when Damage Taken Support" "Cast when Stunned Support" "Caustic Arrow" "Chain Hook" "Chance to Bleed Support" "Chance to Poison Support" "Charged Dash" "Clarity" "Cobra Lash" "Cold Snap" "Conductivity" "Conflagration" "Consecrated Path" "Controlled Destruction Support" "Convocation" "Corrupting Fever" "Crackling Lance" "Cremation" "Cruelty Support" "Damage on Full Life Support" "Deadly Ailments Support" "Decoy Totem" "Defiance Banner" "Desecrate" "Despair" "Determination" "Devouring Totem" "Discipline" "Divine Blast" "Divine Ire" "Dominating Blow" "Double Strike" "Dread Banner" "Dual Strike" "Earthquake" "Earthshatter" "Efficacy Support" "Elemental Damage with Attacks Support" "Elemental Focus Support" "Elemental Penetration Support" "Elemental Weakness" "Enduring Cry" "Energy Blade" "Enfeeble" "Ensnaring Arrow" "Essence Drain" "Eternal Blessing Support" "Ethereal Knives" "Explosive Arrow" "Explosive Concoction" "Explosive Trap" "Feeding Frenzy Support" "Fireball" "Firestorm" "Flame Dash" "Flame Link" "Flame Surge" "Flame Wall" "Flamethrower Trap" "Flammability" "Flesh and Stone" "Flesh Offering" "Forbidden Rite" "Freezing Pulse" "Frenzy" "Frigid Bond Support" "Frost Blades" "Frost Bomb" "Frost Shield" "Frost Wall" "Frostbite" "Frostblink" "Frostbolt" "Galvanic Arrow" "Galvanic Field" "General's Cry" "Generosity Support" "Glacial Cascade" "Glacial Hammer" "Glacial Shield Swipe" "Greater Multiple Projectiles Support" "Greater Volley Support" "Guardian's Blessing Support" "Haste" "Hatred" "Heavy Strike" "Hex Bloom Support" "Hexblast" "Holy Hammers" "Holy Strike" "Holy Sweep" "Hydrosphere" "Ice Crash" "Ice Nova" "Ice Shot" "Ice Spear" "Icicle Mine" "Immolate Support" "Immortal Call" "Impending Doom Support" "Incinerate" "Increased Critical Damage Support" "Increased Critical Strikes Support" "Infernal Blow" "Infernal Cry" "Inspiration Support" "Intuitive Link" "Iron Will Support" "Item Rarity Support" "Kinetic Fusillade" "Kinetic Rain" "Lacerate" "Lancing Steel" "Less Duration Support" "Lifetap Support" "Lightning Arrow" "Lightning Conduit" "Lightning Strike" "Lightning Tendrils" "Lightning Warp" "Living Lightning Support" "Malevolence" "Manaforged Arrows Support" "Mark On Hit Support" "Meat Shield Support" "Melee Physical Damage Support" "Minion Damage Support" "Minion Life Support" "Minion Speed Support" "Mirage Archer Support" "Molten Shell" "More Duration Support" "Penance Brand" "Petrified Blood" "Phase Run" "Physical to Lightning Support" "Plague Bearer" "Poacher's Mark" "Poisonous Concoction" "Power Siphon" "Pride" "Pulverise Support" "Punishment" "Purifying Flame" "Pyroclast Mine" "Rage Vortex" "Reave" "Rejuvenation Totem" "Righteous Fire" "Rolling Magma" "Ruthless Support" "Sacred Wisps Support" "Scorching Ray" "Scourge Arrow" "Seismic Trap" "Shield Charge" "Shock Nova" "Shockwave Totem" "Shrapnel Ballista" "Siphoning Trap" "Slower Projectiles Support" "Smoke Mine" "Snipe" "Sniper's Mark" "Somatic Shell" "Spectral Helix" "Spectral Shield Throw" "Spectral Throw" "Spellslinger" "Spirit Offering" "Split Arrow" "Splitting Steel" "Static Strike" "Steelskin" "Storm Brand" "Storm Burst" "Storm Call" "Stormbind" "Stormblast Mine" "Summon Carrion Golem" "Summon Chaos Golem" "Summon Flame Golem" "Summon Ice Golem" "Summon Lightning Golem" "Summon Reaper" "Summon Skeletons" "Summon Skitterbots" "Summon Stone Golem" "Swift Affliction Support" "Swordstorm" "Tectonic Slam" "Tempest Shield" "Tornado" "Tornado Shot" "Trinity Support" "Unbound Ailments Support" "Unearth" "Unleash Support" "Urgent Orders Support" "Vaal Absolution" "Vaal Arc" "Vaal Arctic Armour" "Vaal Blight" "Vaal Cyclone" "Vaal Discipline" "Vaal Domination" "Vaal Double Strike" "Vaal Grace" "Vaal Haste" "Vaal Molten Shell" "Vaal Righteous Fire" "Vaal Smite" "Vicious Projectiles Support" "Vile Toxins Support" "Viper Strike" "Void Manipulation Support" "Void Sphere" "Volatile Dead" "Volatility Support" "Volcanic Fissure" "Volley Support" "Voltaxic Burst" "Vortex" "Vulnerability" "Warlord's Mark" "Whirling Blades" "Wild Strike" "Winter Orb" "Wither" "Withering Step" "Wrath" "Zealotry"
	SetFontSize 45
	SetTextColor 20 240 240 255
	SetBorderColor 240 0 0 255
	SetBackgroundColor 70 0 20 255
...
Show # %D8 $type->gems->special $tier->xx23
	Quality >= 23
	Class == "Skill Gems" "Support Gems"
	BaseType == "Added Cold Damage Support" "Added Lightning Damage Support" "Arcane Surge Support" "Arcanist Brand" "Arrow Nova Support" "Artillery Ballista" "Automation" "Awakened Added Chaos Damage Support" "Awakened Added Cold Damage Support" "Awakened Added Fire Damage Support" "Awakened Added Lightning Damage Support" "Awakened Ancestral Call Support" "Awakened Arrow Nova Support" "Awakened Blasphemy Support" "Awakened Brutality Support" "Awakened Burning Damage Support" "Awakened Cast On Critical Strike Support" "Awakened Cast While Channelling Support" "Awakened Chain Support" "Awakened Cold Penetration Support" "Awakened Controlled Destruction Support" "Awakened Deadly Ailments Support" "Awakened Elemental Damage with Attacks Support" "Awakened Elemental Focus Support" "Awakened Fire Penetration Support" "Awakened Fork Support" "Awakened Generosity Support" "Awakened Greater Multiple Projectiles Support" "Awakened Hextouch Support" "Awakened Lightning Penetration Support" "Awakened Melee Physical Damage Support" "Awakened Melee Splash Support" "Awakened Minion Damage Support" "Awakened Multistrike Support" "Awakened Spell Cascade Support" "Awakened Spell Echo Support" "Awakened Swift Affliction Support" "Awakened Unbound Ailments Support" "Awakened Unleash Support" "Awakened Vicious Projectiles Support" "Awakened Void Manipulation Support" "Ballista Totem Support" "Berserk" "Blade Flurry" "Blessed Call Support" "Boneshatter" "Cast when Damage Taken Support" "Chance to Bleed Support" "Charged Dash" "Cobra Lash" "Consecrated Path" "Controlled Destruction Support" "Convocation" "Cruelty Support" "Desecrate" "Double Strike" "Earthshatter" "Elemental Damage with Attacks Support" "Elemental Focus Support" "Energy Blade" "Eternal Blessing Support" "Explosive Trap" "Feeding Frenzy Support" "Flame Dash" "Flame Wall" "Flamethrower Trap" "Flammability" "Frenzy" "Frigid Bond Support" "Frostblink" "Frostbolt" "Galvanic Arrow" "Greater Multiple Projectiles Support" "Greater Volley Support" "Holy Sweep" "Ice Shot" "Ice Spear" "Icicle Mine" "Immortal Call" "Incinerate" "Increased Critical Damage Support" "Increased Critical Strikes Support" "Infernal Blow" "Infernal Cry" "Iron Will Support" "Kinetic Fusillade" "Less Duration Support" "Lightning Conduit" "Lightning Strike" "Living Lightning Support" "Manaforged Arrows Support" "Mark On Hit Support" "Melee Physical Damage Support" "Minion Damage Support" "More Duration Support" "Phase Run" "Reave" "Rejuvenation Totem" "Ruthless Support" "Siphoning Trap" "Smoke Mine" "Spellslinger" "Split Arrow" "Static Strike" "Stormblast Mine" "Summon Ice Golem" "Swift Affliction Support" "Trinity Support" "Unbound Ailments Support" "Unleash Support" "Vaal Absolution" "Vaal Discipline" "Vaal Molten Shell" "Vaal Smite" "Vicious Projectiles Support" "Volatility Support" "Voltaxic Burst" "Vulnerability"
	SetFontSize 45
	SetTextColor 20 240 240 255
	SetBorderColor 240 0 0 255
	SetBackgroundColor 70 0 20 255
...
Show # %D8 $type->gems->special $tier->21xx
	GemLevel >= 21
	Class == "Skill Gems" "Support Gems"
	BaseType == "Absolution" "Added Cold Damage Support" "Additional Accuracy Support" "Ancestral Cry" "Anger" "Animate Guardian" "Arcane Cloak" "Arcanist Brand" "Arctic Armour" "Assassin's Mark" "Autoexertion" "Automation" "Blast Rain" "Blastchain Mine Support" "Blessed Call Support" "Bloodthirst Support" "Boneshatter" "Caustic Arrow" "Charged Dash" "Clarity" "Cold Snap" "Concentrated Effect Support" "Consecrated Path" "Conversion Trap" "Corrupting Fever" "Cremation" "Defiance Banner" "Despair" "Determination" "Discipline" "Divine Ire" "Dominating Blow" "Dread Banner" "Elemental Army Support" "Elemental Damage with Attacks Support" "Elemental Focus Support" "Elemental Proliferation Support" "Elemental Weakness" "Enduring Cry" "Energy Blade" "Eternal Blessing Support" "Ethereal Knives" "Explosive Arrow" "Explosive Concoction" "Exsanguinate" "Feeding Frenzy Support" "Firestorm" "Flame Dash" "Flame Link" "Flame Wall" "Flameblast" "Flammability" "Flesh and Stone" "Forbidden Rite" "Fresh Meat Support" "Frost Blades" "Frost Bomb" "Frost Shield" "Frost Wall" "Frostblink" "Glacial Shield Swipe" "Grace" "Greater Volley Support" "Guardian's Blessing Support" "Hallow Support" "Haste" "Hatred" "Heavy Strike" "Hex Bloom Support" "Hexblast" "Holy Hammers" "Holy Strike" "Hydrosphere" "Impending Doom Support" "Increased Critical Damage Support" "Intuitive Link" "Kinetic Rain" "Less Duration Support" "Life Leech Support" "Lifetap Support" "Lightning Arrow" "Lightning Penetration Support" "Lightning Tendrils" "Lightning Warp" "Malevolence" "Minion Life Support" "Mirror Arrow" "Multiple Traps Support" "Multistrike Support" "Pestilent Strike" "Petrified Blood" "Phase Run" "Plague Bearer" "Poacher's Mark" "Poisonous Concoction" "Power Siphon" "Precision" "Pride" "Pulverise Support" "Punishment" "Pyroclast Mine" "Raise Spectre" "Raise Zombie" "Reap" "Rejuvenation Totem" "Righteous Fire" "Ruthless Support" "Searing Bond" "Shockwave Support" "Smite" "Soulrend" "Spirit Offering" "Split Arrow" "Splitting Steel" "Storm Burst" "Stormblast Mine" "Summon Carrion Golem" "Summon Chaos Golem" "Summon Ice Golem" "Summon Reaper" "Summon Skeletons" "Summon Skitterbots" "Summon Stone Golem" "Tempest Shield" "Thunderstorm" "Tornado" "Tornado Shot" "Trap and Mine Damage Support" "Vaal Absolution" "Vaal Arc" "Vaal Blight" "Vaal Discipline" "Vaal Double Strike" "Vaal Grace" "Vaal Haste" "Vaal Molten Shell" "Vaal Righteous Fire" "Vaal Smite" "Vitality" "Void Manipulation Support" "Volatile Dead" "Volatility Support" "Vulnerability" "Whirling Blades" "Winter Orb" "Wintertide Brand" "Wither" "Wrath" "Zealotry"
	SetFontSize 45
	SetTextColor 20 240 240 255
	SetBorderColor 240 0 0 255
	SetBackgroundColor 70 0 20 255
...
Show # %D6 $type->gems->special $tier->vaal20
	Quality >= 20
	Class == "Skill Gems" "Support Gems"
	BaseType == "Vaal Absolution" "Vaal Arc" "Vaal Blight" "Vaal Cyclone" "Vaal Discipline" "Vaal Domination" "Vaal Double Strike" "Vaal Grace" "Vaal Haste" "Vaal Molten Shell" "Vaal Righteous Fire" "Vaal Smite"
	SetFontSize 45
	SetTextColor 20 240 240 255
	SetBorderColor 240 0 0 255
	SetBackgroundColor 70 0 20 255
...
Show # $type->uniques->replicas $tier->t1
	Replica True
	Rarity Unique
	BaseType == "Assassin's Boots" "Chain Belt" "Ebony Tower Shield" "Glorious Plate" "Great Crown" "Leather Belt" "Leather Hood" "Maelström Staff" "Ornate Quiver" "Soldier Boots" "Spidersilk Robe" "Terror Maul" "Triumphant Lamellar" "Turquoise Amulet" "Vaal Gauntlets" "Void Sceptre"
	SetFontSize 45
...
Show # %H8 $type->uniques->replicas $tier->t2
	Replica True
	Rarity Unique
	BaseType == "Blood Raiment" "Bronzescale Boots" "Calling Wand" "Carnal Armour" "Cloth Belt" "Cobalt Jewel" "Decimation Bow" "Elegant Ringmail" "Eternal Sword" "Ezomyte Burgonet" "Ezomyte Dagger" "Granite Flask" "Imperial Bow" "Infernal Sword" "Map (Tier 16)" "Murder Boots" "Opal Wand" "Paua Amulet" "Paua Ring" "Rustic Sash" "Sage Wand" "Shadow Sceptre" "Siege Axe" "Sorcerer Gloves" "Stibnite Flask" "Sulphur Flask" "Synthesised Map" "Tornado Wand" "Vaal Claw" "Vaal Rapier"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
...
Show # $type->uniques->replicas $tier->multi
	Replica True
	Rarity Unique
	BaseType == "Gnarled Branch" "Jade Amulet" "Zodiac Leather"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 240 190 255
	SetBackgroundColor 175 96 37 255
...
Show # %H6 $type->uniques->replicas $tier->t3
	Replica True
	Rarity Unique
	BaseType == "Arcanist Gloves" "Arcanist Slippers" "Blasting Wand" "Boot Knife" "Crimson Jewel" "Crusader Chainmail" "Death Bow" "Diamond Ring" "Elder Sword" "Ezomyte Axe" "Festival Mask" "Gold Amulet" "Great Helmet" "Great Mallet" "Grinning Fetish" "Gut Ripper" "Heavy Belt" "Jasper Chopper" "Lacquered Buckler" "Laminated Kite Shield" "Map (Tier 11)" "Map (Tier 14)" "Nailed Fist" "Onyx Amulet" "Ornate Mace" "Royal Skean" "Ruby Ring" "Samite Gloves" "Sanctified Mana Flask" "Sapphire Ring" "Satin Gloves" "Shagreen Boots" "Short Bow" "Silk Slippers" "Sinner Tricorne" "Spike-Point Arrow Quiver" "Stiletto" "Titan Greaves" "Unset Ring" "Viridian Jewel" "War Sword" "Zealot Gloves"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 175 96 37 255
...
Show # $type->uniques->foulborn $tier->t1
	Foulborn True
	Rarity Unique
	BaseType == "Assassin Bow" "Astral Plate" "Branded Kite Shield" "Champion Kite Shield" "Crimson Jewel" "Desert Brigandine" "Devout Chainmail" "Eternal Sword" "Fishing Rod" "Harlequin Mask" "Lunaris Circlet" "Paua Amulet" "Prophecy Wand" "Raven Mask" "Rawhide Boots" "Somatic Wand" "Sorcerer Boots" "Steel Kite Shield" "Titanium Spirit Shield" "Tomahawk" "Topaz Ring" "Wyrmscale Doublet"
	SetFontSize 45
	SetTextColor 175 96 37 255
	SetBorderColor 175 96 37 255
	SetBackgroundColor 255 255 255 255
...
Show # %H8 $type->uniques->foulborn $tier->t2
	Foulborn True
	Rarity Unique
	BaseType == "Abyssal Axe" "Archon Kite Shield" "Assassin's Mitts" "Clasped Mitts" "Cobalt Jewel" "Copper Plate" "Coronal Maul" "Crusader Chainmail" "Crusader Gloves" "Death Bow" "Deerskin Gloves" "Destiny Leather" "Destroyer Regalia" "Dragonscale Boots" "Exquisite Leather" "Ezomyte Burgonet" "Fiend Dagger" "Gladiator Plate" "Gold Ring" "Hubris Circlet" "Iron Circlet" "Iron Ring" "Jasper Chopper" "Jewelled Foil" "Karui Chopper" "Karui Sceptre" "Lathi" "Leather Hood" "Legion Gloves" "Lion Sword" "Majestic Plate" "Maraketh Bow" "Murder Mitts" "Nightmare Bascinet" "Occultist's Vestment" "Ornate Quiver" "Reaver Sword" "Regicide Mask" "Royal Bow" "Saintly Chainmail" "Sapphire Ring" "Scholar's Robe" "Serpentine Staff" "Short Bow" "Silk Gloves" "Sinner Tricorne" "Spiraled Wand" "Steel Gauntlets" "Steelscale Gauntlets" "Studded Belt" "Tarnished Spirit Shield" "Thresher Claw" "Turquoise Amulet" "Two-Point Arrow Quiver" "Vaal Gauntlets" "Vaal Sceptre" "Varnished Coat" "Wool Gloves" "Zealot Helmet"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 175 96 37 255
...
Show # $type->uniques->foulborn $tier->multi
	Foulborn True
	Rarity Unique
	BaseType == "Agate Amulet" "Amber Amulet" "Amethyst Ring" "Calling Wand" "Chain Belt" "Citadel Bow" "Close Helmet" "Cloth Belt" "Crusader Plate" "Cutlass" "Diamond Ring" "Elegant Round Shield" "Ezomyte Tower Shield" "Gavel" "Gilded Sallet" "Golden Mask" "Heavy Belt" "Imperial Claw" "Jade Amulet" "Lacquered Garb" "Lapis Amulet" "Leather Belt" "Midnight Blade" "Mind Cage" "Moonstone Ring" "Necromancer Silks" "Onyx Amulet" "Opal Wand" "Praetor Crown" "Ranger Bow" "Royal Burgonet" "Ruby Ring" "Sadist Garb" "Samite Gloves" "Silken Vest" "Spike-Point Arrow Quiver" "Terror Claw" "Titan Gauntlets" "Titan Greaves" "Two-Stone Ring" "Vaal Axe" "Vaal Spirit Shield" "Viridian Jewel" "Zodiac Leather"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 240 190 255
	SetBackgroundColor 175 96 37 255
...
Show # %H6 $type->uniques->foulborn $tier->t3
	Foulborn True
	Rarity Unique
	BaseType == "Ancient Spirit Shield" "Assassin's Garb" "Blunt Arrow Quiver" "Bronzescale Gauntlets" "Buckskin Tunic" "Carnal Mitts" "Chain Gloves" "Conjurer Gloves" "Corrugated Buckler" "Crystal Belt" "Cutthroat's Garb" "Etched Greatsword" "Full Wyrmscale" "Goat's Horn" "Goathide Boots" "Golden Plate" "Great Helmet" "Harmonic Spirit Shield" "Holy Chainmail" "Ironscale Gauntlets" "Ironwood Buckler" "Kinetic Wand" "Leather Cap" "Legion Boots" "Military Staff" "Mosaic Kite Shield" "Nubuck Boots" "Omen Wand" "Ornate Mace" "Penetrating Arrow Quiver" "Pinnacle Tower Shield" "Plate Vest" "Platinum Sceptre" "Prismatic Ring" "Reinforced Greaves" "Royal Axe" "Sage's Robe" "Silken Hood" "Soldier Boots" "Spidersilk Robe" "Steelhead" "Strapped Mitts" "Terror Maul" "Timeworn Claw" "Triumphant Lamellar" "Vaal Blade" "Vile Staff" "War Buckler" "Widowsilk Robe" "Wyrmscale Gauntlets"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 175 96 37 255
...
Show # $type->fragments->scarabs $tier->t1
	...
	BaseType == "Allflame Ember of Propagation" "Allflame Ember of the Ethereal" "Allflame Ember of the Gilded" "Ambush Scarab of Containment" "Horned Scarab of Awakening" "Horned Scarab of Bloodlines" "Horned Scarab of Preservation"
	SetFontSize 45
...
Show # %H8 $type->fragments->scarabs $tier->t2
	Class == "Map Fragments" "Misc Map Items"
	BaseType == "Abyss Scarab of the Consort" "Allflame Ember of K'Tash" "Allflame Ember of Kulemak" "Allflame Ember of Toads" "Bestiary Scarab of Duplicating" "Blight Scarab of Invigoration" "Cartography Scarab of Corruption" "Cartography Scarab of Risk" "Divination Scarab of Pilfering" "Divination Scarab of The Cloister" "Domination Scarab of Terrors" "Essence Scarab of Adaptation" "Essence Scarab of Ascent" "Essence Scarab of Calcification" "Harvest Scarab of Cornucopia" "Harvest Scarab of Doubling" "Horned Scarab of Glittering" "Horned Scarab of Pandemonium" "Horned Scarab of Tradition" "Incursion Scarab of Timelines" "Legion Scarab of Eternal Conflict" "Scarab of Monstrous Lineage" "Ultimatum Scarab of Catalysing" "Ultimatum Scarab of Dueling"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 180 0 255 255
...
Show # %D7 $type->fragments->scarabs $tier->t3stackedex
	StackSize >= 3
	Class == "Map Fragments" "Misc Map Items"
	BaseType == "Allflame Ember of Flesh" "Allflame Ember of the Wildwood" "Ambush Scarab" "Ambush Scarab of Hidden Compartments" "Ambush Scarab of Potency" "Anarchy Scarab" "Anarchy Scarab of Partnership" "Anarchy Scarab of the Exceptional" "Betrayal Scarab" "Betrayal Scarab of Reinforcements" "Betrayal Scarab of the Allflame" "Beyond Scarab" "Beyond Scarab of Haemophilia" "Breach Scarab of the Hive" "Cartography Scarab of Escalation" "Delirium Scarab of Delusions" "Domination Scarab of Apparitions" "Essence Scarab" "Essence Scarab of Stability" "Expedition Scarab" "Expedition Scarab of Infusion" "Expedition Scarab of Runefinding" "Expedition Scarab of Verisium Powder" "Harvest Scarab" "Incursion Scarab" "Incursion Scarab of Invasion" "Influencing Scarab of Hordes" "Influencing Scarab of the Elder" "Influencing Scarab of the Shaper" "Kalguuran Scarab" "Kalguuran Scarab of Guarded Riches" "Legion Scarab of Officers" "Ritual Scarab of Wisps" "Scarab of Adversaries" "Scarab of Stability" "Scarab of the Sinistral" "Sulphite Scarab of Fumes" "Titanic Scarab of Legend" "Titanic Scarab of Treasures" "Torment Scarab of Peculiarity" "Ultimatum Scarab" "Ultimatum Scarab of Bribing"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 180 0 255 255
...
Show # %HS6 $type->fragments->scarabs $tier->t3
	Class == "Map Fragments" "Misc Map Items"
	BaseType == "Abyss Scarab" "Abyss Scarab of Crystals" "Abyss Scarab of Descending" "Abyss Scarab of Multitudes" "Allflame Ember of Resplendence" "Ambush Scarab of Discernment" "Anarchy Scarab of Gigantification" "Bestiary Scarab" "Bestiary Scarab of the Herd" "Betrayal Scarab of Unbreaking" "Beyond Scarab of Resurgence" "Beyond Scarab of the Invasion" "Blight Scarab" "Blight Scarab of Blooming" "Blight Scarab of the Blightheart" "Breach Scarab of Instability" "Breach Scarab of Resonant Cascade" "Breach Scarab of the Incensed Swarm" "Breach Scarab of the Marshal" "Cartography Scarab of the Multitude" "Delirium Scarab" "Delirium Scarab of Mania" "Delirium Scarab of Neuroses" "Delirium Scarab of Paranoia" "Divination Scarab of Plenty" "Domination Scarab" "Domination Scarab of Evolution" "Expedition Scarab of Archaeology" "Horned Scarab of Nemeses" "Incursion Scarab of Champions" "Influencing Scarab of Interference" "Kalguuran Scarab of Enriching" "Kalguuran Scarab of Refinement" "Legion Scarab" "Legion Scarab of Treasures" "Ritual Scarab of Abundance" "Ritual Scarab of Corpses" "Ritual Scarab of Selectiveness" "Scarab of Divinity" "Scarab of Radiant Storms" "Scarab of the Dextral" "Scarab of Wisps" "Sulphite Scarab" "Titanic Scarab" "Torment Scarab" "Torment Scarab of Possession" "Trarthan Scarab" "Trarthan Scarab of Infamy" "Trarthan Scarab of Renown" "Trarthan Scarab of Surprising Alliances" "Ultimatum Scarab of Inscription"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 180 0 255 255
...
Show # $type->fragments $tier->t1
	Class == "Map Fragments" "Misc Map Items"
	BaseType == "Dedication to the Goddess" "Echo of Reverence" "Gift to the Goddess" "Incandescent Invitation" "Screaming Invitation" "Syndicate Medallion" "The Black Barya" "The Maven's Writ" "Tribute to the Goddess"
	SetFontSize 45
	SetTextColor 180 0 255 255
	SetBorderColor 180 0 255 255
	SetBackgroundColor 255 255 255 255
...
Show # %H8 $type->fragments $tier->t2
	Class == "Map Fragments" "Misc Map Items"
	BaseType == "Al-Hezmin's Crest" "An Audience With The King" "Awakening Fragment" "Baran's Crest" "Blazing Fragment" "Cosmic Fragment" "Decaying Fragment" "Devouring Fragment" "Drox's Crest" "Echo of Loneliness" "Echo of Trauma" "Fragment of Constriction" "Fragment of Emptiness" "Fragment of Enslavement" "Fragment of Eradication" "Fragment of Knowledge" "Fragment of Purification" "Fragment of Shape" "Fragment of Terror" "Fragment of the Chimera" "Fragment of the Hydra" "Fragment of the Minotaur" "Fragment of the Phoenix" "Hivebrain Gland" "Lonely Fragment" "Mercenary Warrant" "Mortal Hope" "Mortal Ignorance" "Reality Fragment" "Reverent Fragment" "Sacred Blossom" "Simulacrum" "Synthesising Fragment" "Timeless Eternal Emblem" "Timeless Karui Emblem" "Timeless Maraketh Emblem" "Timeless Templar Emblem" "Timeless Vaal Emblem" "Traumatic Fragment" "Veritania's Crest" "Zorath's Eye of Authority" "Zorath's Eye of Malevolence" "Zorath's Eye of the Endless" "Zorath's Eye of the Inevitable"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 180 0 255 255
...
Show # %H7 $type->fragments $tier->t4
	Class == "Map Fragments" "Misc Map Items"
	BaseType == "Blood-filled Vessel" "Divine Vessel" "Mortal Grief" "Mortal Rage" "Offering to the Goddess" "Polaric Invitation" "Sacrifice at Dawn" "Sacrifice at Dusk" "Sacrifice at Midnight" "Writhing Invitation"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 175 120 230 240
...
Show # %H8 $type->vials $tier->t2
	Class == "Stackable Currency"
	BaseType == "Vial of Summoning" "Vial of the Ghost" "Vial of Transcendence"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 90 35 255
...
Show # %HS4 $type->vials $tier->t3
	Class == "Stackable Currency"
	BaseType == "Vial of Awakening" "Vial of Consequence" "Vial of Dominance" "Vial of Fate" "Vial of the Ritual"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 249 150 25 255
...
Show # %H8 $type->currency->deliriumorbs $tier->t2
	Class == "Stackable Currency"
	BaseType == "Armoursmith's Delirium Orb" "Diviner's Delirium Orb" "Fine Delirium Orb"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 90 35 255
...
Show # %H7 $type->currency->deliriumorbs $tier->t3
	Class == "Stackable Currency"
	BaseType == "Abyssal Delirium Orb" "Blacksmith's Delirium Orb" "Blighted Delirium Orb" "Cartographer's Delirium Orb" "Fragmented Delirium Orb" "Jeweller's Delirium Orb" "Singular Delirium Orb" "Skittering Delirium Orb" "Thaumaturge's Delirium Orb" "Timeless Delirium Orb" "Whispering Delirium Orb"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 249 150 25 255
...
Show # $type->currency->fossil $tier->t1
	...
	BaseType == "Faceted Fossil" "Fractured Fossil" "Glyphic Fossil" "Hollow Fossil" "Prime Chaotic Resonator"
	SetFontSize 45
	SetTextColor 255 0 0 255
	SetBorderColor 255 0 0 255
	SetBackgroundColor 255 255 255 255
...
Show # %H8 $type->currency->fossil $tier->t2
	Class == "Delve Stackable Socketable Currency" "Stackable Currency"
	BaseType == "Gilded Fossil" "Opulent Fossil" "Sanctified Fossil"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 90 35 255
...
Show # %HS5 $type->currency->fossil $tier->t3
	Class == "Delve Stackable Socketable Currency" "Stackable Currency"
	BaseType == "Aberrant Fossil" "Aetheric Fossil" "Bloodstained Fossil" "Bound Fossil" "Corroded Fossil" "Dense Fossil" "Jagged Fossil" "Lucent Fossil" "Metallic Fossil" "Prismatic Fossil" "Pristine Fossil" "Serrated Fossil" "Shuddering Fossil" "Tangled Fossil"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 240 90 35 255
...
Show # %HS4 $type->currency->fossil $tier->t4
	Class == "Delve Stackable Socketable Currency" "Stackable Currency"
	BaseType == "Deft Fossil" "Frigid Fossil" "Fundamental Fossil" "Potent Chaotic Resonator" "Powerful Chaotic Resonator" "Primitive Chaotic Resonator" "Scorched Fossil"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 249 150 25 255
...
Show # %H9 $type->currency->ducats $tier->t2
	Class == "Stackable Currency"
	BaseType == "Brinehook's Ducat" "Cyaxan's Ducat" "Katakohi's Ducat" "Kishara's Ducat" "Merrick's Ducat" "Rotmother's Ducat" "Telesia's Ducat" "The Changeling's Ducat" "Tzamoto's Ducat"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 90 35 255
...
Hide # $type->currency->ducats $tier->exhide
	Class == "Stackable Currency"
	BaseType == "Brinehook's Ducat" "Cyaxan's Ducat" "Katakohi's Ducat" "Kishara's Ducat" "Merrick's Ducat" "Rotmother's Ducat" "Telesia's Ducat" "The Changeling's Ducat" "The Genteel's Ducat" "Tzamoto's Ducat"
	SetFontSize 35
	SetBorderColor 0 0 0
...
Show # $type->currency->oil $tier->t1
	Class == "Stackable Currency"
	BaseType == "Golden Oil" "Prismatic Oil" "Tainted Oil"
	SetFontSize 45
	SetTextColor 255 0 0 255
	SetBorderColor 255 0 0 255
	SetBackgroundColor 255 255 255 255
...
Show # %HS5 $type->currency->oil $tier->t3
	Class == "Stackable Currency"
	BaseType == "Black Oil" "Crimson Oil" "Indigo Oil" "Reflective Oil" "Violet Oil"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 240 90 35 255
...
Show # %HS4 $type->currency->oil $tier->t4
	Class == "Stackable Currency"
	BaseType == "Amber Oil" "Azure Oil" "Teal Oil" "Verdant Oil"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 249 150 25 255
...
Show # $type->runesgrafts $tier->t1
	Class == "Stackable Currency"
	BaseType == "Runegraft of Gemcraft" "Runegraft of Stability" "Runegraft of the Angler" "Runegraft of the Fortress" "Runegraft of the Soulwick" "Runegraft of the Warp" "Runegraft of Treachery"
	SetFontSize 45
	SetTextColor 255 0 0 255
	SetBorderColor 255 0 0 255
	SetBackgroundColor 255 255 255 255
...
Show # %H8 $type->runesgrafts $tier->t2
	Class == "Stackable Currency"
	BaseType == "Runegraft of Rotblood"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 90 35 255
...
Show # %HS6 $type->runesgrafts $tier->t3
	Class == "Stackable Currency"
	BaseType == "Runegraft of Fury" "Runegraft of Loyalty" "Runegraft of Rallying" "Runegraft of Restitching" "Runegraft of Suffering" "Runegraft of the Bound" "Runegraft of the Jeweller" "Runegraft of the River" "Runegraft of the Spellbound" "Runegraft of Time"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 240 90 35 255
...
Show # %HS5 $type->runesgrafts $tier->t4
	Class == "Stackable Currency"
	BaseType == "Runegraft of Bellows" "Runegraft of Refraction" "Runegraft of Resurgence" "Runegraft of the Combatant" "Runegraft of the Novamark" "Runegraft of the Sinistral"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 249 150 25 255
...
Show # %HS3 $type->runesgrafts $tier->t5
	Class == "Stackable Currency"
	BaseType == "Runegraft of Blasphemy" "Runegraft of Connection" "Runegraft of Consecration" "Runegraft of Quaffing" "Runegraft of the Agile" "Runegraft of the Imbued" "Runegraft of the Witchmark"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 210 178 135 255
...
Show # %H8 $type->currency->trial->omen $tier->t2
	Class == "Stackable Currency"
	BaseType == "Omen of Amelioration" "Omen of Trichromatism"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 90 35 255
...
Show # %H7 $type->currency->trial->omen $tier->t3
	Class == "Stackable Currency"
	BaseType == "Omen of Adrenaline" "Omen of Brilliance" "Omen of Death-dancing" "Omen of Death's Door" "Omen of the Jeweller"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 240 90 35 255
...
Show # $type->currency->trial->tattoo $tier->t1
	Class == "Stackable Currency"
	BaseType == "Forbidden Tattoo of the Duelist" "Forbidden Tattoo of the Marauder" "Forbidden Tattoo of the Ranger" "Forbidden Tattoo of the Scion" "Forbidden Tattoo of the Shadow" "Forbidden Tattoo of the Templar" "Forbidden Tattoo of the Witch" "Honoured Tattoo of the Barbarian" "Honoured Tattoo of the Berserker" "Honoured Tattoo of the Flood" "Honoured Tattoo of the Hunter" "Honoured Tattoo of the Makanga" "Honoured Tattoo of the Mountain" "Honoured Tattoo of the Pa" "Honoured Tattoo of the Storm" "Honoured Tattoo of the Warlord" "Honoured Tattoo of the Wise" "Journey Tattoo of Makanui" "Journey Tattoo of the Body" "Journey Tattoo of the Mind" "Tattoo of the Arohongui Shaman" "Tattoo of the Hinekora Warmonger" "Tattoo of the Hinekora Warrior" "Tattoo of the Kitava Warrior" "Tattoo of the Ngamahu Firewalker" "Tattoo of the Ngamahu Makanga" "Tattoo of the Ramako Fleetfoot" "Tattoo of the Ramako Makanga" "Tattoo of the Ramako Shaman" "Tattoo of the Rongokurai Turtle" "Tattoo of the Tawhoa Shaman" "Tattoo of the Valako Shieldbearer"
	SetFontSize 45
	SetTextColor 255 0 0 255
	SetBorderColor 255 0 0 255
	SetBackgroundColor 255 255 255 255
...
Show # %H8 $type->currency->trial->tattoo $tier->t2
	Class == "Stackable Currency"
	BaseType == "Ancestral Tattoo of Bloodlines" "Honoured Tattoo of the Flock" "Honoured Tattoo of the Hatungo" "Honoured Tattoo of the Pillager" "Honoured Tattoo of the Turtle" "Journey Tattoo of the Soul" "Tattoo of the Arohongui Makanga" "Tattoo of the Arohongui Moonwarden" "Tattoo of the Arohongui Warmonger" "Tattoo of the Hinekora Makanga" "Tattoo of the Hinekora Storyteller" "Tattoo of the Kitava Shaman" "Tattoo of the Ngamahu Warrior" "Tattoo of the Rongokurai Warrior" "Tattoo of the Tasalio Makanga" "Tattoo of the Tasalio Scout" "Tattoo of the Tawhoa Makanga" "Tattoo of the Tukohama Makanga" "Tattoo of the Tukohama Shaman" "Tattoo of the Valako Makanga"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 240 90 35 255
...
Show # %H7 $type->currency->trial->tattoo $tier->t3
	Class == "Stackable Currency"
	BaseType == "Honoured Tattoo of the Dove" "Honoured Tattoo of the Oak" "Honoured Tattoo of the Sky" "Honoured Tattoo of the Tuatara" "Loyalty Tattoo of Ahuana" "Loyalty Tattoo of Akoya" "Loyalty Tattoo of Ikiaho" "Loyalty Tattoo of Kahuturoa" "Loyalty Tattoo of Kaom" "Loyalty Tattoo of Kiloava" "Loyalty Tattoo of Maata" "Loyalty Tattoo of Rakiata" "Loyalty Tattoo of Tawhanuku" "Loyalty Tattoo of Utula" "Tattoo of the Kitava Makanga" "Tattoo of the Ngamahu Warmonger" "Tattoo of the Ngamahu Woodcarver" "Tattoo of the Ramako Archer" "Tattoo of the Ramako Sniper" "Tattoo of the Rongokurai Makanga" "Tattoo of the Tawhoa Scout" "Tattoo of the Tukohama Warcaller" "Tattoo of the Tukohama Warmonger" "Tattoo of the Valako Stormrider" "Tattoo of the Valako Warrior"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 240 90 35 255
...
Show # %H6 $type->currency->trial->tattoo $tier->t4
	Class == "Stackable Currency"
	BaseType == "Tattoo of the Arohongui Scout" "Tattoo of the Arohongui Warrior" "Tattoo of the Hinekora Deathwarden" "Tattoo of the Hinekora Shaman" "Tattoo of the Kitava Blood Drinker" "Tattoo of the Kitava Heart Eater" "Tattoo of the Kitava Rebel" "Tattoo of the Ngamahu Shaman" "Tattoo of the Ramako Scout" "Tattoo of the Rongokurai Brute" "Tattoo of the Rongokurai Goliath" "Tattoo of the Rongokurai Guard" "Tattoo of the Tasalio Bladedancer" "Tattoo of the Tasalio Shaman" "Tattoo of the Tasalio Tideshifter" "Tattoo of the Tasalio Warrior" "Tattoo of the Tawhoa Herbalist" "Tattoo of the Tawhoa Naturalist" "Tattoo of the Tawhoa Warrior" "Tattoo of the Tukohama Brawler" "Tattoo of the Tukohama Warrior" "Tattoo of the Valako Scout" "Tattoo of the Valako Shaman"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 249 150 25 255
...
Show # $type->divination $tier->t1
	Class == "Divination Cards"
	BaseType == "Apocalypse" "Beauty Through Death" "Brother's Gift" "Choking Guilt" "Damnation" "Divine Beauty" "Divine Justice" "Father's Love" "Fire Of Unknown Origin" "History" "House of Mirrors" "I See Brothers" "Lonely Warrior" "Love Through Ice" "Lucky Bastion" "Outfoxed" "Reflection of the Heart" "Seven Years Bad Luck" "Succor of the Sinless" "The Apothecary" "The Demon" "The Doctor" "The Dragon's Heart" "The Endless Darkness" "The Enlightened" "The Eye of Terror" "The Fiend" "The Immortal" "The Insane Cat" "The Miracle" "The Nurse" "The Price of Devotion" "The Progeny of Lunaris" "The Samurai's Eye" "The Sephirot" "The Shieldbearer" "The Slumbering Beast" "The Soul" "The Strategist" "Unrequited Love" "Wealth and Power"
	SetFontSize 45
	SetTextColor 0 0 255 255
	SetBorderColor 0 0 255 255
	SetBackgroundColor 255 255 255 255
...
Show # %H8 $type->divination $tier->t2
	Class == "Divination Cards"
	BaseType == "A Fate Worse Than Death" "A Stone Perfected" "Assassin's Gift" "Azyran's Reward" "Bound by Flame" "Brother's Stash" "Darker Half" "Desecrated Virtue" "Duality" "Friendship" "Gemcutter's Mercy" "Gift of Asenath" "Home" "Imperfect Memories" "Judging Voices" "Last Stand" "Lethean Temptation" "Luminous Trove" "Misery in Darkness" "Monochrome" "One Last Score" "Squandered Prosperity" "The Academic" "The Artist" "The Astromancer" "The Chosen" "The Damned" "The Deep Ones" "The Destination" "The Eldritch Decay" "The Escape" "The Eternal War" "The Everlasting" "The Forbidden Fruit" "The Formless Sea" "The Fortunate" "The Garish Power" "The Greatest Intentions" "The Gulf" "The Heroic Shot" "The Hook" "The Journey" "The Lake" "The Last One Standing" "The Last Supper" "The Leviathan" "The Long Con" "The Mayor" "The Old Man" "The One That Got Away" "The Pact" "The Patient" "The Price of Loyalty" "The Professor" "The Queen" "The Rabbit's Foot" "The Sacrifice" "The Shortcut" "The Spark and the Flame" "The Vast" "The World Eater" "Tranquillity" "Underground Forest" "Winter's Embrace"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
...
Show # %HS6 $type->divination $tier->t3
	Class == "Divination Cards"
	BaseType == "A Chilling Wind" "A Familiar Call" "A Modest Request" "A Note in the Wind" "Abandoned Wealth" "Akil's Prophecy" "Alluring Bounty" "Altered Perception" "Ambitious Obsession" "Auspicious Ambitions" "Avian Pursuit" "Bijoux" "Broken Promises" "Broken Truce" "Brotherhood in Exile" "Burning Blood" "Chaotic Disposition" "Costly Curio" "Council of Cats" "Dark Dreams" "Dark Temptation" "Deadly Joy" "Deathly Designs" "Demigod's Wager" "Desperate Crusade" "Doryani's Epiphany" "Draped in Dreams" "Eldritch Perfection" "Endless Night" "Eternal Bonds" "Fateful Meeting" "Guardian's Challenge" "Haunting Shadows" "Heterochromia" "Hunter's Reward" "Keeper's Corruption" "Lachrymal Necrosis" "Last Hope" "Light and Truth" "Lingering Remnants" "Lucky Deck" "Magnum Opus" "Matryoshka" "Mawr Blaidd" "Peaceful Moments" "Pride Before the Fall" "Pride of the First Ones" "Prosperity" "Rebirth and Renewal" "Remembrance" "Sambodhi's Wisdom" "Silence and Frost" "Something Dark" "Temperance" "Terrible Secret of Space" "The Admirer" "The Aspirant" "The Bitter Blossom" "The Brawny Battle Mage" "The Breach" "The Celestial Justicar" "The Chains that Bind" "The Craving" "The Dreamer" "The Enforcer" "The Enthusiasts" "The Ethereal" "The Eye of the Dragon" "The Finishing Touch" "The Fishmonger" "The Forward Gaze" "The Gemcutter" "The Hive of Knowledge" "The Hunger" "The Innocent" "The King's Heart" "The Last Laugh" "The Life Thief" "The Lion" "The Long Watch" "The Mad King" "The Magma Crab" "The Messenger" "The Offspring" "The Poet" "The Polymath" "The Price of Prescience" "The Price of Protection" "The Primordial" "The Prince of Darkness" "The Risk" "The Rusted Bard" "The Saint's Treasure" "The Scout" "The Seeker" "The Shepherd's Sandals" "The Side Quest" "The Silly Boy" "The Tireless Extractor" "The Tumbleweed" "The Undaunted" "The Unexpected Prize" "The Union" "The Valkyrie" "The Void" "The Wedding Gift" "Treasure Hunter" "Unchained" "Who Asked"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
...
Show # $type->divination $tier->tnew
	Class == "Divination Cards"
	BaseType == "Divine Shard" "Energy Sword" "Pearls Before Swine"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
...
Show # %HS4 $type->divination $tier->t4c
	Class == "Divination Cards"
	BaseType == "A Sea of Blue" "Acclimatisation" "Boon of Justice" "Brush, Paint and Palette" "Buried Treasure" "Cameria's Cut" "Checkmate" "Coveted Possession" "Dementophobia" "Dialla's Subjugation" "Disdain" "Emperor's Luck" "Ever-Changing" "Harmony of Souls" "Humility" "Immortal Resolve" "Lucky Connections" "Man With Bear" "More is Never Enough" "No Traces" "Rebirth" "Runic Luck" "Sambodhi's Vow" "Society's Remorse" "The Cacophony" "The Card Sharp" "The Deal" "The Doppelganger" "The Fool" "The Hoarder" "The Inventor" "The Master Artisan" "The Survivalist" "The Tinkerer's Table" "The Transformation" "The White Knight" "The Wrath" "Three Faces in the Dark" "Vanity" "Vinia's Token"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
...
Show # %HS2 $type->divination $tier->t5c
	Class == "Divination Cards"
	BaseType == "Gemcutter's Promise" "Her Mask" "Loyalty" "Rain of Chaos" "The Catalyst" "The Flora's Gift" "The Gambler" "The Scholar" "Three Voices" "Volatile Power"
	SetFontSize 45
...
Show # %HS3 $type->divination $tier->t4
	Class == "Divination Cards"
	BaseType == "A Dab of Ink" "A Dusty Memory" "Alone in the Darkness" "Anarchy's Price" "Arrogance of the Vaal" "Assassin's Favour" "Astral Protection" "Atziri's Arsenal" "Azure Rage" "Baited Expectations" "Blind Venture" "Boon of the First Ones" "Bowyer's Dream" "Chasing Risk" "Doedre's Madness" "Dying Anguish" "Dying Light" "Earth Drinker" "Emperor of Purity" "Etched in Blood" "From Bone to Ashes" "Further Invention" "Gift of the Gemling Queen" "Glimmer of Hope" "Hope" "Hubris" "Hunter's Resolve" "Imperial Legacy" "Jack in the Box" "Justified Ambition" "Left to Fate" "Lost Worlds" "Lysah's Respite" "Merciless Armament" "Mitts" "Nook's Crown" "Parasitic Passengers" "Perfection" "Poisoned Faith" "Prejudice" "Prometheus' Armoury" "Reckless Ambition" "Scholar of the Seas" "Shard of Fate" "The Aesthete" "The Archmage's Right Hand" "The Avenger" "The Awakened" "The Battle Born" "The Bear Woman" "The Betrayal" "The Blazing Fire" "The Blessing of Moosh" "The Body" "The Bones" "The Brittle Emperor" "The Cache" "The Cataclysm" "The Catch" "The Celestial Stone" "The Coming Storm" "The Conduit" "The Cursed King" "The Dapper Prodigy" "The Dark Mage" "The Darkest Dream" "The Dragon" "The Dreamland" "The Dungeon Master" "The Easy Stroll" "The Encroaching Darkness" "The Fathomless Depths" "The Forgotten Treasure" "The Fox" "The Gentleman" "The Hale Heart" "The Jeweller's Boon" "The Mercenary" "The Mind's Eyes" "The Mountain" "The Oath" "The Offering" "The One With All" "The Penitent" "The Porcupine" "The Rite of Elements" "The Road to Power" "The Scavenger" "The Skeleton" "The Spoiled Prince" "The Stormcaller" "The Summoner" "The Thaumaturgist" "The Throne" "The Tower" "The Traitor" "The Twilight Moon" "The Tyrant" "The Undisputed" "The Warlord" "The Whiteout" "The Wilted Rose" "The Wind" "The Wolf" "The Wolf's Legacy" "The Wolven King's Bite" "The Wolverine" "The Wretched" "Time-Lost Relic" "Toxic Tidings" "Triskaidekaphobia" "Void of the Elements" "When Currents Blaze"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 39 141 192 255
...
Hide # %H0 $type->divination $tier->t5
	Class == "Divination Cards"
	BaseType == "A Mother's Parting Gift" "Alivia's Grace" "Audacity" "Boundless Realms" "Call to the First Ones" "Cartographer's Delight" "Cursed Words" "Death" "Destined to Crumble" "Echoes of Love" "Forbidden Power" "Grave Knowledge" "Lantador's Lost Love" "Might is Right" "Rain Tempter" "Rats" "Struck by Lightning" "The Adventuring Spirit" "The Arena Champion" "The Army of Blood" "The Beast" "The Calling" "The Carrion Crow" "The Deceiver" "The Demoness" "The Drunken Aristocrat" "The Endurance" "The Explorer" "The Feast" "The Fletcher" "The Forsaken" "The Fox in the Brambles" "The Gladiator" "The Golden Era" "The Harvester" "The Hermit" "The Incantation" "The Inoculated" "The Insatiable" "The Jester" "The Journalist" "The King's Blade" "The Lich" "The Lord in Black" "The Lord of Celebration" "The Lover" "The Lunaris Priestess" "The Metalsmith's Gift" "The Opulent" "The Pack Leader" "The Rabid Rhoa" "The Realm" "The Return of the Rat" "The Ruthless Ceinture" "The Scarred Meadow" "The Sigil" "The Siren" "The Standoff" "The Sun" "The Surgeon" "The Surveyor" "The Sword King's Salute" "The Trial" "The Twins" "The Visionary" "The Warden" "The Watcher" "The Web" "The Witch" "The Wolf's Shadow" "Thirst for Knowledge" "Thunderous Skies" "Turn the Other Cheek" "Vile Power"
	SetFontSize 35
	SetTextColor 39 141 192 255
	SetBorderColor 39 141 192 255
	SetBackgroundColor 20 20 0 255
...
Show # $type->uniques $tier->t1
	Rarity Unique
	BaseType == "Assassin's Boots" "Cabalist Regalia" "Candlestick Relic" "Champion Kite Shield" "Crusader Boots" "Dusk Blade" "Engraved Greatsword" "Fluted Bascinet" "Formless Ring" "Foul Staff" "Fugitive Ring" "Ghastly Eye Jewel" "Girded Tower Shield" "Gold Flask" "Greatwolf Talisman" "Imperial Maul" "Iron Flask" "Karui Maul" "Lacewood Spirit Shield" "Leather Hood" "Lich's Circlet" "Murderous Eye Jewel" "Pagan Wand" "Papyrus Relic" "Prismatic Jewel" "Prophecy Wand" "Raven Mask" "Ring" "Riveted Boots" "Ruby Flask" "Savant's Robe" "Shadow Sceptre" "Siege Axe" "Siege Helmet" "Slaughter Knife" "Spectral Axe" "Unset Amulet" "Vaal Rapier" "Vermillion Ring" "Wyrmscale Doublet"
	SetFontSize 45
	SetTextColor 175 96 37 255
	SetBorderColor 175 96 37 255
	SetBackgroundColor 255 255 255 255
...
Show # %H8 $type->uniques $tier->t2
	Rarity Unique
	BaseType == "Amethyst Flask" "Astrolabe Amulet" "Blood Raiment" "Butcher Axe" "Carnal Boots" "Censer Relic" "Coronal Maul" "Crimson Round Shield" "Cryonic Ring" "Devout Chainmail" "Embroidered Gloves" "Enthalpic Ring" "Exquisite Blade" "Ezomyte Dagger" "Faithful Helmet" "Faun's Horn" "Fingerless Silk Gloves" "Gemstone Sword" "General's Brigandine" "Gladiator Plate" "Golden Buckler" "Graceful Sword" "Hypnotic Eye Jewel" "Imperial Bow" "Jewelled Foil" "Jingling Spirit Shield" "Large Cluster Jewel" "Majestic Plate" "Maraketh Bow" "Martyr Gloves" "Medium Cluster Jewel" "Murder Mitts" "Organic Ring" "Ornate Quiver" "Pig-Faced Bascinet" "Piledriver" "Processional Relic" "Rawhide Boots" "Reinforced Greaves" "Rhex Talisman" "Riveted Gloves" "Runic Gages" "Runic Helm" "Runic Sollerets" "Sacrificial Garb" "Sapphire Flask" "Scholar's Robe" "Seaglass Amulet" "Searching Eye Jewel" "Serpentscale Boots" "Silk Gloves" "Simple Robe" "Slink Boots" "Soldier Helmet" "Somatic Wand" "Spiny Round Shield" "Steel Kite Shield" "Steel Ring" "Stygian Vise" "Synaptic Ring" "Timeless Jewel" "Titanium Spirit Shield" "Torturer Garb" "Vaal Mask" "Vaal Spirit Shield" "Void Axe" "Wyrmscale Boots"
	SetFontSize 45
	SetTextColor 255 255 255 255
	SetBorderColor 255 255 255 255
	SetBackgroundColor 175 96 37 255
...
Show # $type->uniques $tier->multispecialhigh
	Rarity Unique
	BaseType == "Cutlass" "Elegant Round Shield" "Heavy Belt" "Hellion's Paw" "Imperial Skean" "Imperial Staff" "Leather Belt" "Magistrate Crown" "Maple Round Shield" "Murder Boots" "Opal Wand" "Paua Amulet" "Sage's Robe" "Small Cluster Jewel" "Spine Bow" "Turquoise Amulet" "Unset Ring" "Vaal Blade" "Vaal Claw" "Visored Sallet" "Waxed Garb"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 175 96 37 255
...
Show # %H7 $type->uniques $tier->multispecial
	Rarity Unique
	BaseType == "Amethyst Ring" "Archon Kite Shield" "Assassin Bow" "Astral Plate" "Cloth Belt" "Crude Bow" "Crusader Plate" "Crystal Sceptre" "Deicide Mask" "Demon Dagger" "Ebony Tower Shield" "Ezomyte Burgonet" "Fiend Dagger" "Gavel" "Ghostflame Blade" "Glorious Plate" "Goathide Boots" "Gold Ring" "Golden Mask" "Granite Flask" "Great Mallet" "Highborn Staff" "Hubris Circlet" "Hydrascale Gauntlets" "Iron Circlet" "Karui Sceptre" "Lacquered Buckler" "Lacquered Garb" "Lapis Amulet" "Moonstone Ring" "Necromancer Circlet" "Onyx Amulet" "Prophet Crown" "Quarterstaff" "Royal Burgonet" "Sadist Garb" "Sage Wand" "Saint's Hauberk" "Sorcerer Boots" "Spidersilk Robe" "Spiraled Wand" "Stealth Boots" "Steelwood Bow" "Stibnite Flask" "Studded Belt" "Topaz Ring" "Two-Stone Ring" "Vaal Gauntlets" "Vanguard Belt" "Zodiac Leather"
	SetFontSize 45
	SetTextColor 0 0 0 255
	SetBorderColor 0 0 0 255
	SetBackgroundColor 175 96 37 255
...
Show # %H5 $type->uniques $tier->earlyleague
	Rarity Unique
	BaseType == "Blue Pearl Amulet" "Bone Helmet" "Branded Kite Shield" "Bronzescale Gauntlets" "Callous Mask" "Carnal Mitts" "Carnal Sceptre" "Citrine Amulet" "Clasped Mitts" "Coral Amulet" "Deerskin Gloves" "Desert Brigandine" "Destiny Leather" "Diamond Ring" "Eternal Sword" "Exquisite Leather" "Ezomyte Spiked Shield" "Ezomyte Staff" "Festival Mask" "Goathide Gloves" "Gold Amulet" "Hallowed Hybrid Flask" "Karui Chopper" "Kinetic Wand" "Leather Cap" "Legion Boots" "Maelström Staff" "Mirrored Spiked Shield" "Mosaic Kite Shield" "Occultist's Vestment" "Omen Wand" "Painted Tower Shield" "Platinum Sceptre" "Prismatic Ring" "Rawhide Tower Shield" "Rustic Sash" "Saintly Chainmail" "Serpentscale Gauntlets" "Short Bow" "Sinner Tricorne" "Solaris Circlet" "Vaal Hatchet" "Varnished Coat" "Velvet Gloves" "Wyrmscale Gauntlets"
	SetFontSize 45
	SetTextColor 175 96 37 255
	SetBorderColor 175 96 37 255
	SetBackgroundColor 10 30 45 255
...
Show # %H5 $type->uniques $tier->t3boss
	Rarity Unique
	BaseType == "Abyssal Axe" "Agate Amulet" "Amber Amulet" "Ambush Mitts" "Ambusher" "Ancient Gauntlets" "Antique Gauntlets" "Assassin's Mitts" "Bismuth Flask" "Black Maw Talisman" "Blood Sceptre" "Bone Circlet" "Broadhead Arrow Quiver" "Cardinal Round Shield" "Carnal Armour" "Chain Belt" "Citadel Bow" "Coffer Relic" "Coiled Staff" "Colossal Mana Flask" "Colossal Tower Shield" "Colosseum Plate" "Crusader Gloves" "Dragonscale Boots" "Ezomyte Tower Shield" "Fugitive Boots" "Gladius" "Golden Plate" "Goliath Gauntlets" "Goliath Greaves" "Great Crown" "Harlequin Mask" "Hydrascale Boots" "Imperial Claw" "Infernal Sword" "Jade Amulet" "Judgement Staff" "Lacquered Helmet" "Legion Gloves" "Legion Sword" "Lion Sword" "Marble Amulet" "Nightmare Mace" "Opal Ring" "Paladin Crown" "Paua Ring" "Praetor Crown" "Primordial Staff" "Ruby Ring" "Runic Crown" "Runic Gauntlets" "Runic Sabatons" "Sapphire Ring" "Sentinel Jacket" "Serpentine Staff" "Silken Hood" "Silver Flask" "Soldier Gloves" "Spiked Gloves" "Steel Circlet" "Steelscale Gauntlets" "Sulphur Flask" "Titan Gauntlets" "Titan Greaves" "Tome Relic" "Topaz Flask" "Tornado Wand" "Triumphant Lamellar" "Urn Relic" "Vaal Greaves" "Vaal Regalia" "Vaal Sceptre" "Vile Arrow Quiver" "Void Sceptre" "Widowsilk Robe" "Zealot Helmet"
	SetFontSize 45
	SetTextColor 175 96 37 255
	SetBorderColor 175 96 37 255
	SetBackgroundColor 53 13 13 255
...
Show # %H4 $type->uniques $tier->t3
	Rarity Unique
	BaseType == "Ashbark Tincture" "Assassin's Garb" "Baroque Round Shield" "Blunt Arrow Quiver" "Bronze Sceptre" "Cleaver" "Close Helmet" "Coral Ring" "Cutthroat's Garb" "Dream Mace" "Driftwood Wand" "Eternal Burgonet" "Fright Claw" "Grand Mana Flask" "Harmonic Spirit Shield" "Iron Gauntlets" "Iron Ring" "Ironwood Tincture" "Large Hybrid Flask" "Lathi" "Meatgrinder" "Mesh Gloves" "Mind Cage" "Necromancer Silks" "Nightmare Bascinet" "Nubuck Boots" "Oakbranch Tincture" "Plated Greaves" "Platinum Kris" "Prismatic Tincture" "Ranger Bow" "Royal Sceptre" "Royal Skean" "Rusted Sword" "Sanctified Life Flask" "Satin Gloves" "Satin Slippers" "Sharktooth Arrow Quiver" "Shield Crab Talisman" "Slink Gloves" "Sporebloom Tincture" "Strapped Mitts" "Tricorne" "Two-Point Arrow Quiver" "Two-Toned Boots" "Vaal Axe" "Wolf Alpha Talisman" "Wolf Pelt"
	SetFontSize 45
	SetTextColor 175 96 37 255
	SetBorderColor 175 96 37 255
	SetBackgroundColor 53 13 13 255
...
Show # %H3 $type->uniques $tier->hideable2
	Rarity Unique
	BaseType == "Despot Axe" "Elegant Ringmail" "Elegant Sword" "Nameless Ring" "Phantom Mace" "Pinnacle Tower Shield" "Sovereign Spiked Shield" "Tyrant's Sekhem" "Zealot Gloves"
	SetFontSize 40
	SetTextColor 175 96 37 255
	SetBorderColor 175 96 37 255
	SetBackgroundColor 20 20 0 255
...
Show # %H3 $type->uniques $tier->hideable
	Rarity Unique
	BaseType == "Ancient Greaves" "Ancient Spirit Shield" "Antique Greaves" "Antique Rapier" "Arcanist Gloves" "Arcanist Slippers" "Auric Mace" "Aventail Helmet" "Awl" "Barbute Helmet" "Basket Rapier" "Bastard Sword" "Blasting Wand" "Blazing Arrow Quiver" "Bone Armour" "Boot Blade" "Boot Knife" "Brass Maul" "Brass Spirit Shield" "Bronze Gauntlets" "Bronzescale Boots" "Buckskin Tunic" "Calling Wand" "Cedar Tower Shield" "Chain Gloves" "Chiming Spirit Shield" "Clasped Boots" "Compound Spiked Shield" "Conjurer Boots" "Conjurer Gloves" "Conquest Chainmail" "Copper Plate" "Corrugated Buckler" "Corsair Sword" "Crusader Chainmail" "Crystal Belt" "Death Bow" "Decimation Bow" "Decorative Axe" "Deerskin Boots" "Destroyer Regalia" "Diamond Flask" "Dragonscale Gauntlets" "Dread Maul" "Eelskin Boots" "Eelskin Gloves" "Elder Sword" "Enameled Buckler" "Estoc" "Etched Greatsword" "Ezomyte Axe" "Ezomyte Blade" "Feathered Arrow Quiver" "Flaying Knife" "Full Dragonscale" "Full Wyrmscale" "Gilded Sallet" "Gnarled Branch" "Goat's Horn" "Great Helmet" "Greater Mana Flask" "Grinning Fetish" "Gut Ripper" "Harbinger Bow" "Headsman Axe" "Heavy Arrow Quiver" "Highland Blade" "Holy Chainmail" "Infernal Axe" "Iron Hat" "Iron Mask" "Iron Staff" "Ironscale Boots" "Ironscale Gauntlets" "Ironwood Buckler" "Jade Hatchet" "Jagged Foil" "Jagged Maul" "Jasper Chopper" "Laminated Kite Shield" "Latticed Ringmail" "Lion Pelt" "Long Bow" "Lunaris Circlet" "Mesh Boots" "Midnight Blade" "Military Staff" "Nailed Fist" "Nubuck Gloves" "Opal Sceptre" "Ornate Mace" "Ornate Ringmail" "Ornate Sword" "Painted Buckler" "Penetrating Arrow Quiver" "Pine Buckler" "Plague Mask" "Plank Kite Shield" "Plate Vest" "Poleaxe" "Polished Spiked Shield" "Primal Arrow Quiver" "Quartz Flask" "Quicksilver Flask" "Reaver Helmet" "Reaver Sword" "Recurve Bow" "Regicide Mask" "Reinforced Tower Shield" "Ritual Sceptre" "Rock Breaker" "Rotted Round Shield" "Royal Axe" "Royal Bow" "Royal Staff" "Sabre" "Samite Gloves" "Samnite Helmet" "Sanctified Mana Flask" "Scholar Boots" "Secutor Helm" "Serrated Arrow Quiver" "Shackled Boots" "Shadow Axe" "Shagreen Boots" "Shagreen Gloves" "Sharkskin Boots" "Sharkskin Tunic" "Silk Slippers" "Silken Vest" "Skinning Knife" "Sledgehammer" "Soldier Boots" "Spike-Point Arrow Quiver" "Spiked Club" "Steel Gauntlets" "Steelhead" "Stiletto" "Strapped Boots" "Studded Round Shield" "Sun Leather" "Supreme Spiked Shield" "Tarnished Spirit Shield" "Teak Round Shield" "Terror Claw" "Terror Maul" "Thresher Claw" "Throat Stabber" "Tiger Sword" "Timeworn Claw" "Tomahawk" "Trapper Boots" "Tribal Circlet" "Twilight Blade" "Ursine Pelt" "Vaal Buckler" "Velvet Slippers" "Vile Staff" "Vine Circlet" "War Buckler" "War Hammer" "War Sword" "Whalebone Rapier" "Wild Leather" "Woodsplitter" "Wool Gloves" "Wool Shoes" "Wrapped Mitts"
	SetFontSize 40
	SetTextColor 175 96 37 255
	SetBorderColor 175 96 37 255
	SetBackgroundColor 20 20 0 255
